...
public class GeneralSLAdapter {
  ...
  private Optional<ValueListRangeLambda> sim_render_frequency = Optional.empty();
  private Optional<ValueListRangeLambda> sim_loop_frequency;
  private Optional<ValueListRangeLambda> sim_duration;
  ...
  private Optional<ValueListRangeLambda> gravity;
  private Optional<ValueListRangeLambda> pedestrian_density;
...
/*
    if(symMap.containsKey("sim_render_frequency")) {
      this.sim_render_frequency = Optional.of(new ValueListRangeLambda(symMap.get("sim_render_frequency")));
    }
    if(symMap.containsKey("sim_loop_frequency")) {
      this.sim_loop_frequency = Optional.of(new ValueListRangeLambda(symMap.get("sim_loop_frequency")));
    }
    if(symMap.containsKey("sim_duration")) {
      this.sim_duration = Optional.of(new ValueListRangeLambda(symMap.get("sim_duration")));
    }
   ...
   *
   */
  public Optional<ValueListRangeLambda> getSimulationRenderFrequency() {
    return this.sim_render_frequency;
  }

  public Optional<ValueListRangeLambda> getSimulationLoopFrequency() {
    return this.sim_loop_frequency;
  }

  public Optional<ValueListRangeLambda> getSimulationDuration() {
  ...
  public Optional<ValueListRangeLambda> getGravity() {
    return this.gravity;
  }
  ...
  public Optional<ValueListRangeLambda> getPedestrianDensity() {
