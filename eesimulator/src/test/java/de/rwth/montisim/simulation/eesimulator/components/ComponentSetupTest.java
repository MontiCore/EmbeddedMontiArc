...
public class ComponentSetupTest {
    ...
    public void multiBus() throws EESetupException, EEMessageTypeException {
        ...
        b4.attachTo(simulator);
        Bus b5 = new ConstantBus(ConstantBusProperties.instantBus().setName("b5"));
        b5.attachTo(simulator);
        TestEEComponent c1, c2, c3, c4, c5, c6;
        c1 = new TestEEComponent("c1"); c1.attachTo(simulator);
        c2 = new TestEEComponent("c2"); c2.attachTo(simulator);
        c3 = new TestEEComponent("c3"); c3.attachTo(simulator);
        c4 = new TestEEComponent("c4"); c4.attachTo(simulator);
        c5 = new TestEEComponent("c5"); c5.attachTo(simulator);
        c6 = new TestEEComponent("c6"); c6.attachTo(simulator);
        ...
        bA.attachTo(simulator);
        TestEEComponent cA, cB;
        cA = new TestEEComponent("cA"); cA.attachTo(simulator);
        cB = new TestEEComponent("cB"); cB.attachTo(simulator);
