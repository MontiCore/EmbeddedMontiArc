...
import {
    MenuPath, MenuContribution, MenuModelRegistry,
...
export const ITEM_CONTEXT_MENU: MenuPath = ["filesystem-dashboard-item-context-menu"];
export const CONTROL_CONTEXT_MENU: MenuPath = ["filesystem-dashboard-control-context-menu"];
