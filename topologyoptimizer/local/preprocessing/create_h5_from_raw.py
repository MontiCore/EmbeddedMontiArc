...
if __name__ == "__main__":
    ...
    write_hdf5(data_dict, path="./h5/raw")
    write_dgl(graph_dict, path="./h5/raw")
    read_hdf5(path="./h5/raw")
    read_dgl(path="./h5/raw")
