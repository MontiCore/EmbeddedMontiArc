...
log_file = os.path.join(project_root, 'logs', 'dyna.log')

while True:
    logging = open(log_file, 'a')
    logging.write("Start dyna.py \n")
    print("Start dyna.py")
    time_counter = 0
    ...
    logging.write("Dyna has finished! \n")
