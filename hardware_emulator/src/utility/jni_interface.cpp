...
void JNIEnvironment::init(JNIEnv* jni)
{
    ...
    resolve_class(jni, CppBridge_class, "de/rwth/monticore/EmbeddedMontiArc/simulators/hardware_emulator/CppBridge");
    resolve_static_method(jni, CppBridge_class, CppBridge_addOneOutput_method,
        "addOneOutput", "(Ljava/util/HashMap;Ljava/lang/String;Ljava/io/Serializable;)V");
}
