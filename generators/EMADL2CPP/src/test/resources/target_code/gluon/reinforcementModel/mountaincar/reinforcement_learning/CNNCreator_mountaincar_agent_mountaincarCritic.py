...
from CNNDatasets_mountaincar_agent_mountaincarCritic import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_mountaincar_agent_mountaincarCritic: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "mountaincar.agent.MountaincarCritic")
