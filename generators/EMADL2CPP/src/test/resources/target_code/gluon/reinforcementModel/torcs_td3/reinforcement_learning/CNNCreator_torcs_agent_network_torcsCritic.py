...
from CNNDataLoader_torcs_agent_network_torcsCritic import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_torcs_agent_network_torcsCritic: # pylint: disable=invalid-name
    _model_basedir_ = pathlib.Path("model", "torcs.agent.network.TorcsCritic")
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 29,), ctx=context[0]), mx.nd.zeros((batch_size, 3,), ctx=context[0]))
