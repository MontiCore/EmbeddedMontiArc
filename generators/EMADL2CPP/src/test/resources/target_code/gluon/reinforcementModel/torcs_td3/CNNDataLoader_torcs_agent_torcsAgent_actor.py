...
from CNNDatasets_torcs_agent_torcsAgent_actor import Dataset, TrainingDataset, RetrainingConf

class CNNDataLoader_torcs_agent_torcsAgent_actor: # pylint: disable=invalid-name
    _input_names_ = ['state']
    _output_names_ = ['action_label']

    def __init__(self):
        self._data_dir = pathlib.Path("data/")
