...
from CNNDatasets_torcs_agent_torcsAgent_dqn import Dataset, TrainingDataset, RetrainingConf

class CNNDataLoader_torcs_agent_torcsAgent_dqn: # pylint: disable=invalid-name
    _input_names_ = ['state']
