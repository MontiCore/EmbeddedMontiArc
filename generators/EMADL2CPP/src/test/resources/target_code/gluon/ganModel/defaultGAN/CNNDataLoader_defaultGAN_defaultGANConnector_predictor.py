...
from CNNDatasets_defaultGAN_defaultGANConnector_predictor import Dataset, TrainingDataset, RetrainingConf

class CNNDataLoader_defaultGAN_defaultGANConnector_predictor: # pylint: disable=invalid-name
    _input_names_ = ['noise']
    ...
    def __init__(self, data_cleaner):
        ...
        self._model_dir_   = os.path.join(os.path.join('./'), 'model', 'defaultGAN.DefaultGANGenerator')
