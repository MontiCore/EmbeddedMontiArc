...
#ifndef CNNPREDICTOR_CVAE_CONNECTOR_DECODER
#define CNNPREDICTOR_CVAE_CONNECTOR_DECODER
...
#include <CNNLAOptimizer_cvae_connector_decoder.h>
...
public:
    ...
    explicit CNNPredictor_cvae_connector_decoder_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_cvae_connector_decoder_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cvae_connector_decoder optimizer_creator = CNNLAOptimizer_cvae_connector_decoder();
...
#endif // CNNPREDICTOR_CVAE_CONNECTOR_DECODER
