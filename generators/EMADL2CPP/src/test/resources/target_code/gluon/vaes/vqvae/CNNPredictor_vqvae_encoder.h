...
#ifndef CNNPREDICTOR_VQVAE_ENCODER
#define CNNPREDICTOR_VQVAE_ENCODER
...
#include <CNNLAOptimizer_vqvae_encoder.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_vqvae_encoder_0{
public:
    const std::string file_prefix = "model/vqvae.Encoder/model_0_newest";
    ...
    explicit CNNPredictor_vqvae_encoder_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_vqvae_encoder_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_vqvae_encoder optimizer_creator = CNNLAOptimizer_vqvae_encoder();
...
#endif // CNNPREDICTOR_VQVAE_ENCODER
