...
from CNNNet_vqvae_encoder import Net_0

from CNNDatasets_vqvae_encoder import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_vqvae_encoder: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "vqvae.Encoder")
