...
from CNNNet_vqvae_connector_decoder import Net_0

from CNNDatasets_vqvae_connector_decoder import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_vqvae_connector_decoder: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "vqvae.Decoder")
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 16,7,7,), ctx=context[0]))
