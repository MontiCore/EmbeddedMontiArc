...
#ifndef DETECTION_OBJECTDETECTOR2_SPECTRALCLUSTERER_1__EIGENSOLVER
#define DETECTION_OBJECTDETECTOR2_SPECTRALCLUSTERER_1__EIGENSOLVER
#ifndef M_PI
...
class detection_objectDetector2_spectralClusterer_1__eigenSolver{
const int n = 2500;
