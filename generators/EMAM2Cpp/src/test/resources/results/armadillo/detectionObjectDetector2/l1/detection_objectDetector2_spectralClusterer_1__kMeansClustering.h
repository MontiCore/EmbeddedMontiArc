...
#ifndef DETECTION_OBJECTDETECTOR2_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#define DETECTION_OBJECTDETECTOR2_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#ifndef M_PI
...
class detection_objectDetector2_spectralClusterer_1__kMeansClustering{
const int n = 2500;
