...
#ifndef DETECTION_OBJECTDETECTOR4_SPECTRALCLUSTERER_1__SIMILARITY
#define DETECTION_OBJECTDETECTOR4_SPECTRALCLUSTERER_1__SIMILARITY
#ifndef M_PI
...
class detection_objectDetector4_spectralClusterer_1__similarity{
const int n = 50;
public:
mat red;
mat green;
