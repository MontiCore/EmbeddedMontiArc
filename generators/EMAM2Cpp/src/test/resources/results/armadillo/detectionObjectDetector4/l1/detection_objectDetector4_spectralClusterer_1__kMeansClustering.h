...
#ifndef DETECTION_OBJECTDETECTOR4_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#define DETECTION_OBJECTDETECTOR4_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#ifndef M_PI
...
class detection_objectDetector4_spectralClusterer_1__kMeansClustering{
const int n = 2500;
