...
#ifndef DETECTION_OBJECTDETECTOR7_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#define DETECTION_OBJECTDETECTOR7_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#ifndef M_PI
...
class detection_objectDetector7_spectralClusterer_1__kMeansClustering{
const int n = 2500;
