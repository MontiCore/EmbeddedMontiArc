...
#ifndef DETECTION_OBJECTDETECTOR7_SPECTRALCLUSTERER_1__EIGENSOLVER
#define DETECTION_OBJECTDETECTOR7_SPECTRALCLUSTERER_1__EIGENSOLVER
#ifndef M_PI
...
class detection_objectDetector7_spectralClusterer_1__eigenSolver{
const int n = 2500;
