...
#ifndef DETECTION_OBJECTDETECTOR7_SPECTRALCLUSTERER_1__SIMILARITY
#define DETECTION_OBJECTDETECTOR7_SPECTRALCLUSTERER_1__SIMILARITY
#ifndef M_PI
...
class detection_objectDetector7_spectralClusterer_1__similarity{
const int n = 50;
public:
mat red;
mat green;
