...
#ifndef DETECTION_OBJECTDETECTOR3_SPECTRALCLUSTERER_1__EIGENSOLVER
#define DETECTION_OBJECTDETECTOR3_SPECTRALCLUSTERER_1__EIGENSOLVER
#ifndef M_PI
...
class detection_objectDetector3_spectralClusterer_1__eigenSolver{
const int n = 2500;
