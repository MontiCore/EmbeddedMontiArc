...
spectralClusterer.normalizedLaplacian.similarity = spectralClusterer.similarity.similarity;
spectralClusterer.normalizedLaplacian.degree = spectralClusterer.similarity.degree;
std::thread thread9( [ this ] {this->spectralClusterer[0].normalizedLaplacian.execute();});
std::thread thread10( [ this ] {this->spectralClusterer[1].normalizedLaplacian.execute();});
std::thread thread11( [ this ] {this->spectralClusterer[2].normalizedLaplacian.execute();});
std::thread thread12( [ this ] {this->spectralClusterer[3].normalizedLaplacian.execute();});
std::thread thread13( [ this ] {this->spectralClusterer[4].normalizedLaplacian.execute();});
std::thread thread14( [ this ] {this->spectralClusterer[5].normalizedLaplacian.execute();});
std::thread thread15( [ this ] {this->spectralClusterer[6].normalizedLaplacian.execute();});
std::thread thread16( [ this ] {this->spectralClusterer[7].normalizedLaplacian.execute();});
thread9.join();
thread10.join();
thread11.join();
thread12.join();
...
spectralClusterer.eigenSolver.matrix = spectralClusterer.normalizedLaplacian.nLaplacian;
spectralClusterer.eigenSolver.matrix = spectralClusterer.normalizedLaplacian.nLaplacian;
std::thread thread17( [ this ] {this->spectralClusterer[0].eigenSolver.execute();});
std::thread thread18( [ this ] {this->spectralClusterer[1].eigenSolver.execute();});
std::thread thread19( [ this ] {this->spectralClusterer[2].eigenSolver.execute();});
std::thread thread20( [ this ] {this->spectralClusterer[3].eigenSolver.execute();});
std::thread thread21( [ this ] {this->spectralClusterer[4].eigenSolver.execute();});
std::thread thread22( [ this ] {this->spectralClusterer[5].eigenSolver.execute();});
std::thread thread23( [ this ] {this->spectralClusterer[6].eigenSolver.execute();});
std::thread thread24( [ this ] {this->spectralClusterer[7].eigenSolver.execute();});
thread17.join();
thread18.join();
thread19.join();
thread20.join();
...
spectralClusterer.kMeansClustering.vectors = spectralClusterer.eigenSolver.eigenvectors;
spectralClusterer.kMeansClustering.vectors = spectralClusterer.eigenSolver.eigenvectors;
std::thread thread25( [ this ] {this->spectralClusterer[0].kMeansClustering.execute();});
std::thread thread26( [ this ] {this->spectralClusterer[1].kMeansClustering.execute();});
std::thread thread27( [ this ] {this->spectralClusterer[2].kMeansClustering.execute();});
std::thread thread28( [ this ] {this->spectralClusterer[3].kMeansClustering.execute();});
std::thread thread29( [ this ] {this->spectralClusterer[4].kMeansClustering.execute();});
std::thread thread30( [ this ] {this->spectralClusterer[5].kMeansClustering.execute();});
std::thread thread31( [ this ] {this->spectralClusterer[6].kMeansClustering.execute();});
std::thread thread32( [ this ] {this->spectralClusterer[7].kMeansClustering.execute();});
thread25.join();
thread26.join();
thread27.join();
thread28.join();
