...
spectralClusterer[8].similarity.red = red9;
spectralClusterer[8].similarity.green = green9;
spectralClusterer[8].similarity.blue = blue9;
...
std::thread thread8( [ this ] {this->spectralClusterer[7].similarity.execute();});
std::thread thread9( [ this ] {this->spectralClusterer[8].similarity.execute();});
thread1.join();
thread2.join();
thread3.join();
thread4.join();
...
spectralClusterer[8].normalizedLaplacian.similarity = spectralClusterer[8].similarity.similarity;
spectralClusterer[8].normalizedLaplacian.degree = spectralClusterer[8].similarity.degree;
std::thread thread10( [ this ] {this->spectralClusterer[0].normalizedLaplacian.execute();});
std::thread thread11( [ this ] {this->spectralClusterer[1].normalizedLaplacian.execute();});
std::thread thread12( [ this ] {this->spectralClusterer[2].normalizedLaplacian.execute();});
std::thread thread13( [ this ] {this->spectralClusterer[3].normalizedLaplacian.execute();});
std::thread thread14( [ this ] {this->spectralClusterer[4].normalizedLaplacian.execute();});
std::thread thread15( [ this ] {this->spectralClusterer[5].normalizedLaplacian.execute();});
std::thread thread16( [ this ] {this->spectralClusterer[6].normalizedLaplacian.execute();});
std::thread thread17( [ this ] {this->spectralClusterer[7].normalizedLaplacian.execute();});
std::thread thread18( [ this ] {this->spectralClusterer[8].normalizedLaplacian.execute();});
thread10.join();
thread11.join();
thread12.join();
thread13.join();
...
spectralClusterer[8].eigenSolver.matrix = spectralClusterer[8].normalizedLaplacian.nLaplacian;
std::thread thread19( [ this ] {this->spectralClusterer[0].eigenSolver.execute();});
std::thread thread20( [ this ] {this->spectralClusterer[1].eigenSolver.execute();});
std::thread thread21( [ this ] {this->spectralClusterer[2].eigenSolver.execute();});
std::thread thread22( [ this ] {this->spectralClusterer[3].eigenSolver.execute();});
std::thread thread23( [ this ] {this->spectralClusterer[4].eigenSolver.execute();});
std::thread thread24( [ this ] {this->spectralClusterer[5].eigenSolver.execute();});
std::thread thread25( [ this ] {this->spectralClusterer[6].eigenSolver.execute();});
std::thread thread26( [ this ] {this->spectralClusterer[7].eigenSolver.execute();});
std::thread thread27( [ this ] {this->spectralClusterer[8].eigenSolver.execute();});
thread19.join();
thread20.join();
thread21.join();
thread22.join();
...
spectralClusterer[8].kMeansClustering.vectors = spectralClusterer[8].eigenSolver.eigenvectors;
std::thread thread28( [ this ] {this->spectralClusterer[0].kMeansClustering.execute();});
std::thread thread29( [ this ] {this->spectralClusterer[1].kMeansClustering.execute();});
std::thread thread30( [ this ] {this->spectralClusterer[2].kMeansClustering.execute();});
std::thread thread31( [ this ] {this->spectralClusterer[3].kMeansClustering.execute();});
std::thread thread32( [ this ] {this->spectralClusterer[4].kMeansClustering.execute();});
std::thread thread33( [ this ] {this->spectralClusterer[5].kMeansClustering.execute();});
std::thread thread34( [ this ] {this->spectralClusterer[6].kMeansClustering.execute();});
std::thread thread35( [ this ] {this->spectralClusterer[7].kMeansClustering.execute();});
std::thread thread36( [ this ] {this->spectralClusterer[8].kMeansClustering.execute();});
thread28.join();
thread29.join();
thread30.join();
thread31.join();
...
clusters[8] = spectralClusterer[8].kMeansClustering.clusters;
}
