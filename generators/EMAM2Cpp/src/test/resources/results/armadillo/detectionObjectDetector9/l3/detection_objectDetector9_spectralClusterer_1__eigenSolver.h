...
#ifndef DETECTION_OBJECTDETECTOR9_SPECTRALCLUSTERER_1__EIGENSOLVER
#define DETECTION_OBJECTDETECTOR9_SPECTRALCLUSTERER_1__EIGENSOLVER
#ifndef M_PI
...
class detection_objectDetector9_spectralClusterer_1__eigenSolver{
const int n = 2500;
