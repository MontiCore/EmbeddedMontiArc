...
#ifndef TEST_MATH_INVCOMMANDTEST
#define TEST_MATH_INVCOMMANDTEST
#ifndef M_PI
...
class test_math_invCommandTest{
public:
...
Matrix a = (Helper::getMatrixFromOctaveListFirstResult(Finv(Helper::convertToOctaveValueList(mat),1)));
}
