...
#ifndef TEST_MATH_EIGVECCOMMANDTEST
#define TEST_MATH_EIGVECCOMMANDTEST
#ifndef M_PI
...
class test_math_eigvecCommandTest{
public:
...
RowVector a = (Helper::getColumnVectorFromOctaveListFirstResult(Feig(Helper::convertToOctaveValueList(mat),2)));
}
