#ifndef DE_RWTH_ARMIN_MODELING_AUTOPILOT_AUTOPILOT_BEHAVIORGENERATION_CALCMOTIONCMDS_DRIVETOFIRSTPOSITION
#define DE_RWTH_ARMIN_MODELING_AUTOPILOT_AUTOPILOT_BEHAVIORGENERATION_CALCMOTIONCMDS_DRIVETOFIRSTPOSITION
#ifndef M_PI
...
#include <thread>
class de_rwth_armin_modeling_autopilot_autopilot_behaviorGeneration_calcMotionCmds_driveToFirstPosition{
public:
