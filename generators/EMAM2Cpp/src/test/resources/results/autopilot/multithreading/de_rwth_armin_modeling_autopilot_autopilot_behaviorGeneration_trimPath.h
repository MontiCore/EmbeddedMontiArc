#ifndef DE_RWTH_ARMIN_MODELING_AUTOPILOT_AUTOPILOT_BEHAVIORGENERATION_TRIMPATH
#define DE_RWTH_ARMIN_MODELING_AUTOPILOT_AUTOPILOT_BEHAVIORGENERATION_TRIMPATH
#ifndef M_PI
...
#include <thread>
class de_rwth_armin_modeling_autopilot_autopilot_behaviorGeneration_trimPath{
public:
