  ...
  class FG_eval_CallIpopt121 {
    public:
      ...
      void operator()(ADvector &fg,const ADvector &vars) {
        ...
        fg[0] = ((CONSTANTCONSTANTVECTOR0*CONSTANTCONSTANTVECTOR1)*x);
...
class CallIpopt121
{
  ...
  public:
    static bool solveOptimizationProblemIpOpt(double *x, double *y, double xOut, double yOut)
    {
      bool ok = true;

      size_t n_vars = 1E0 + 0E0;
      size_t n_constraints = 1E0;
