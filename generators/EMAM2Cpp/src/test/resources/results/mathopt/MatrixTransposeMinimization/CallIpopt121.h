...
//Constraints
#define _V_CONSTR0 2 + 0
#define _V_CONSTR1 2 + 1
/*
  ...
  class FG_eval_CallIpopt121 {
    public:
      ...
      void operator()(ADvector &fg,const ADvector &vars) {
        ...
        fg[0] = CONSTANTCONSTANTVECTOR0.t()*(rowvec({x(1-1),x(2-1),0,0}).t());

        //Updates
        {
        // Constraint Functions
            fg[ 1 +_V_CONSTR0 ]  = x(1-1)-1;
            fg[ 1 +_V_CONSTR1 ]  = x(2-1)-1;
        }
        return;
      }
