...
constexpr int PACKET_REQUEST_CONFIG = 10;
...
constexpr int PACKET_SUSPEND = 15; // No Payload
constexpr int PACKET_EMU_ID = 16; // Payload: emulator token
constexpr int PACKET_RECONNECT = 17; // Payload: emulator token