...
#ifndef CNNLAOPTIMIZER_${encoderInstanceName?upper_case}
#define CNNLAOPTIMIZER_${encoderInstanceName?upper_case}
...
class CNNLAOptimizer_${encoderInstanceName}{
private:
...
public:
    explicit CNNLAOptimizer_${encoderInstanceName}(){
...
#endif // CNNLAOPTIMIZER_${encoderInstanceName?upper_case}
