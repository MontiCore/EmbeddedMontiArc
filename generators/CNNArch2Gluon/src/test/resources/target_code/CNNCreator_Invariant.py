...
from CNNNet_Invariant import Net_0
from CNNNet_Invariant import Net_1
from CNNNet_Invariant import Net_2

from CNNDatasets_Invariant import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_Invariant: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "Invariant")
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[2](mx.nd.zeros((batch_size, 1,), ctx=context[0]))
