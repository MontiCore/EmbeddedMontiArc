...
from CNNDatasets_RNNtest import Dataset, TrainingDataset, RetrainingConf
class CNNDataLoader_RNNtest: # pylint: disable=invalid-name
    ...
    def __init__(self, data_cleaner):
        self._data_dir = pathlib.Path("data/RNNtest/")
        self._model_dir_   = os.path.join(os.path.join('./'), 'model', 'RNNtest')
