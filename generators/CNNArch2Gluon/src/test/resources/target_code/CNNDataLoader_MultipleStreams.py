...
class CNNDataLoader_MultipleStreams: # pylint: disable=invalid-name
    ...
    _output_names_ = ['pred_0_label','pred_1_label']

    def __init__(self, data_cleaner):
        self._data_dir = pathlib.Path("data/MultipleStreams/")
        self._model_dir_   = os.path.join(os.path.join('./'), 'model', 'MultipleStreams')
