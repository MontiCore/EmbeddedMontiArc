...
try:
    ...
    pass
from CNNDatasets_Encoder import TrainingDataset
...
class CNNSupervisedTrainer_Encoder:
    ...
    def train(self, batch_size=64,
        ...
        if preprocessing:
            preproc_lib = "CNNPreprocessor_Encoder_executor"
        ...
        for epoch in range(begin_epoch, begin_epoch + num_epoch):
            ...
            for batch_i, batch in enumerate(train_iter):
                ...
                with autograd.record():
                    ...
                    encoding_ = [mx.nd.zeros((single_pu_batch_size, 2,), ctx=context) for context in mx_context]
            ...
            if eval_train:
                ...
                for batch_i, batch in enumerate(train_iter):
                    if True: # This statement is needed because of different indentations in FreeMarker
                        ...
                        encoding_ = mx.nd.zeros((single_pu_batch_size, 2,), ctx=mx_context[0])
