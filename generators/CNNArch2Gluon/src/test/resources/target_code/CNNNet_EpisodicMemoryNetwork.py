    ...
    def __init__(self, mx_context=None, **kwargs):
        ...
        with self.name_scope():
            self.memory1_ = EpisodicMemory(replay_interval=78, replay_batch_size=100, replay_steps=1,
                                                replay_gradient_steps=1, store_prob=1,
                                                max_stored_samples=-1, memory_replacement_strategy="no_replacement", use_replay=True,
                                                use_local_adaptation=True, local_adaptation_gradient_steps=30, k=32,
