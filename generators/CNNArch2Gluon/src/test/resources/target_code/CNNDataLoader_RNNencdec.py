...
from CNNDatasets_RNNencdec import Dataset, TrainingDataset, RetrainingConf

class CNNDataLoader_RNNencdec: # pylint: disable=invalid-name
    ...
    def __init__(self, data_cleaner):
        self._data_dir = pathlib.Path("data/RNNencdec/")
        self._model_dir_   = os.path.join(os.path.join('./'), 'model', 'RNNencdec')
