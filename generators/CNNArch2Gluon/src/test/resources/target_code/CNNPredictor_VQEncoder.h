...
#ifndef CNNPREDICTOR_VQENCODER
#define CNNPREDICTOR_VQENCODER
...
#include <CNNLAOptimizer_VQEncoder.h>
...
public:
    ...
    explicit CNNPredictor_VQEncoder_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_VQEncoder_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_VQEncoder optimizer_creator = CNNLAOptimizer_VQEncoder();
