...
from CNNDatasets_Show_attend_tell import Dataset, TrainingDataset, RetrainingConf

class CNNDataLoader_Show_attend_tell: # pylint: disable=invalid-name
    _input_names_ = ['images']
    _output_names_ = ['target_0_label','target_1_label','target_2_label','target_3_label','target_4_label','target_5_label','target_6_label','target_7_label','target_8_label','target_9_label','target_10_label','target_11_label','target_12_label','target_13_label','target_14_label','target_15_label','target_16_label','target_17_label','target_18_label','target_19_label','target_20_label','target_21_label','target_22_label','target_23_label','target_24_label']

    def __init__(self, data_cleaner):
        self._data_dir = pathlib.Path("data/Show_attend_tell/")
        self._model_dir_   = os.path.join(os.path.join('./'), 'model', 'Show_attend_tell')
