...
from CNNNet_ResNeXt50 import Net_0

from CNNDatasets_ResNeXt50 import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_ResNeXt50: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "ResNeXt50")
