...
class Net_0(gluon.HybridBlock):
    def __init__(self, data_mean=None, data_std=None, mx_context=None, batch_size=None, **kwargs):
        ...
        with self.name_scope():
            ...
            self.vectorquantize1_ = VectorQuantize(num_embeddings=64,
                                                  embedding_dim=1,
                                                  input_shape=(1,28,28),
                                                  total_feature_maps_size=int(1*28*28))
    ...
    def hybrid_forward(self, F, data_):
        ...
        vectorquantize1_, vectorquantize1__commit_loss, vectorquantize1__codebook_loss = self.vectorquantize1_(data_)
        loss_params.append(vectorquantize1__commit_loss)
        loss_params.append(vectorquantize1__codebook_loss)
