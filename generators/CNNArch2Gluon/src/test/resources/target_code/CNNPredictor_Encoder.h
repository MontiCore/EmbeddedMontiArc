...
#ifndef CNNPREDICTOR_ENCODER
#define CNNPREDICTOR_ENCODER
...
#include <CNNLAOptimizer_Encoder.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_Encoder_0{
public:
    const std::string file_prefix = "model/Encoder/model_0_newest";
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_Encoder optimizer_creator = CNNLAOptimizer_Encoder();
