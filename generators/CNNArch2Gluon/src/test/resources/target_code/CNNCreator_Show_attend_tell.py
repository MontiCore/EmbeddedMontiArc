...
from CNNNet_Show_attend_tell import Net_0
from CNNNet_Show_attend_tell import Net_1
from CNNNet_Show_attend_tell import Net_2

from CNNDatasets_Show_attend_tell import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_Show_attend_tell: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "Show_attend_tell")
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 1,), ctx=context[0]))
        ...
        self.networks[1](mx.nd.zeros((batch_size, 3,224,224,), ctx=context[0]))
        ...
        self.networks[2](mx.nd.zeros((batch_size, 256,), ctx=context[0]), mx.nd.zeros((batch_size, 1,512,), ctx=context[0]), mx.nd.zeros((batch_size, 1,), ctx=context[0]), mx.nd.zeros((batch_size, 1,512,), ctx=context[0]))
