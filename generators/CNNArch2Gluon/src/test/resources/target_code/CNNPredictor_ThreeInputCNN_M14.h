...
#include <CNNLAOptimizer_ThreeInputCNN_M14.h>
...
public:
    ...
    const std::vector<std::vector<mx_uint>> network_input_shapes = {{1, 3, 200, 300}, {1, 3, 200, 300}, {1, 3, 200, 300}};
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_ThreeInputCNN_M14 optimizer_creator = CNNLAOptimizer_ThreeInputCNN_M14();
