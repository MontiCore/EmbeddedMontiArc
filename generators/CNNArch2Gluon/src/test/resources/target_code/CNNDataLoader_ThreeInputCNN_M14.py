...
from CNNDatasets_ThreeInputCNN_M14 import Dataset, TrainingDataset, RetrainingConf

class CNNDataLoader_ThreeInputCNN_M14: # pylint: disable=invalid-name
    _input_names_ = ['data_0', 'data_1', 'data_2']
    _output_names_ = ['predictions_label']

    def __init__(self, data_cleaner):
        self._data_dir = pathlib.Path("data/ThreeInputCNN_M14/")
        self._model_dir_   = os.path.join(os.path.join('./'), 'model', 'ThreeInputCNN_M14')
