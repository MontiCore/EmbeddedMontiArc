...
public:
    const std::string graph_file = "model/MultipleStreams/model_cpp_pred.meta";
    const std::string param_prefix = "model/MultipleStreams/model_cpp_pred";
    ...
    void predict(const std::vector<float> &data_0_, const std::vector<float> &data_1_,
                 std::vector<float> &pred_0_, std::vector<float> &pred_1_){
		

		std::vector<std::string> inputKeys = {"data_0_","data_1_"};
		
		
		std::vector<std::vector<float>> inputShapes = {{1,10},{1,10}};
		std::vector<tensorflow::TensorShape> inputShapesTensor = {tensorflow::TensorShape({1,10}),tensorflow::TensorShape({1,10})};
		
		std::vector<std::vector<float>> inputs =  {data_0_,data_1_};
        ...
        std::vector<std::string> outputKeys = {"output_0","output_1"};
		...
		std::vector<std::vector<float>*> outputs =  {&pred_0_,&pred_1_};
