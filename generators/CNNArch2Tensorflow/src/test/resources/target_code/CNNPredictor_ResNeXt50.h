...
public:
    const std::string graph_file = "model/ResNeXt50/model_cpp_pred.meta";
    const std::string param_prefix = "model/ResNeXt50/model_cpp_pred";
    ...
    void predict(const std::vector<float> &data_,
		...
		std::vector<std::vector<float>> inputShapes = {{1,3,224,224}};
		std::vector<tensorflow::TensorShape> inputShapesTensor = {tensorflow::TensorShape({1,3,224,224})};
