...
export function bindFrontendService<T>(bind: Bind, path: string, serviceIdentifier: ServiceIdentifier<T>) {
...
export function bindBackendService<T>(bind: Bind, path: string, serviceIdentifier: ServiceIdentifier<T>) {
