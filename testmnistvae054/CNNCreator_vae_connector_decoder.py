...
from CNNNet_vae_connector_decoder import Net_0

class CNNCreator_vae_connector_decoder:
    _model_dir_ = "model/vae.Decoder/"
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 8,), ctx=context[0]))
    ...
    def getInputs(self):
        inputs = {}
        input_dimensions = (8,)
        input_domains = (float,-1000.0,1000.0,)
