...
class CNNSupervisedTrainer_vae_encoder:
    ...
    def train(self, batch_size=64,
        ...
        if preprocessing:
            preproc_lib = "CNNPreprocessor_vae_encoder_executor"
        ...
        for epoch in range(begin_epoch, begin_epoch + num_epoch):
            ...
            for batch_i, batch in enumerate(train_iter):
                ...
                with autograd.record():
                    ...
                    encoding_ = [mx.nd.zeros((single_pu_batch_size, 8,), ctx=context) for context in mx_context]
            ...
            if eval_train:
                ...
                for batch_i, batch in enumerate(train_iter):
                    ...
                    encoding_ = mx.nd.zeros((single_pu_batch_size, 8,), ctx=mx_context[0])
