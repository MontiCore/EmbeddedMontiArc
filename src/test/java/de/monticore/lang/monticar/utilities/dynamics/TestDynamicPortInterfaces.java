...
public class TestDynamicPortInterfaces extends BaseTest {
    ...
    public void Test_01_execution_valid() {
        ...
        int r = BaseTest.validExecution("./src/test/resources/emam/dynamics/interface", "./target/tmp/dynamics-inerface/01");
