#ifndef BA_SYSTEM_COLLISIONDETECTION_RECTINTERSECTION_1__RECTTOLINES2
#define BA_SYSTEM_COLLISIONDETECTION_RECTINTERSECTION_1__RECTTOLINES2
#ifndef M_PI
#define M_PI 3.14159265358979323846
#endif
#include "armadillo.h"
#include "types/ba_struct_Rectangle.h"
#include "ba_system_collisionDetection_rectIntersection_1__rectToLines2_rectToPoints.h"
#include "ba_system_collisionDetection_rectIntersection_1__rectToLines2_pointsToLine_1_.h"
using namespace arma;
class ba_system_collisionDetection_rectIntersection_1__rectToLines2{
public:
ba_struct_Rectangle rect;
mat lines[4];
ba_system_collisionDetection_rectIntersection_1__rectToLines2_rectToPoints rectToPoints;
ba_system_collisionDetection_rectIntersection_1__rectToLines2_pointsToLine_1_ pointsToLine[4];
void init()
{
lines[0]=mat(4,1);
lines[1]=mat(4,1);
