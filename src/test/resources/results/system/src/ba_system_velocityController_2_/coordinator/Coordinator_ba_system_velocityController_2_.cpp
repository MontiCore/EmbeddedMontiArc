...
#include "RosAdapter_ba_system_velocityController_2_.h"
...
void startMiddleware(IAdapter_ba_system_velocityController_2_& adapter,ba_system_velocityController_2_& comp,atomic<bool>& done){
  adapter.init(&comp);
  done = true;
}
...
int main(int argc, char* argv[])
{
  ...
  ba_system_velocityController_2_ comp;
  comp.init(3);

  list<IAdapter_ba_system_velocityController_2_*> adapters;
    adapters.push_back(new RosAdapter_ba_system_velocityController_2_());
