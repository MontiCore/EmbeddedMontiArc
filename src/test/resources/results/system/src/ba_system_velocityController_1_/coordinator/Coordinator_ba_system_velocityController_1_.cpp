...
#include "RosAdapter_ba_system_velocityController_1_.h"
...
void startMiddleware(IAdapter_ba_system_velocityController_1_& adapter,ba_system_velocityController_1_& comp,atomic<bool>& done){
  adapter.init(&comp);
  done = true;
}
...
int main(int argc, char* argv[])
{
  ...
  ba_system_velocityController_1_ comp;
  comp.init(3);

  list<IAdapter_ba_system_velocityController_1_*> adapters;
    adapters.push_back(new RosAdapter_ba_system_velocityController_1_());
