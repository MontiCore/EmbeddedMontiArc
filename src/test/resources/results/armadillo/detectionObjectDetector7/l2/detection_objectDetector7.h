...
std::thread thread7( [ this ] {this->spectralClusterer[6].similarity.execute();});
thread1.join();
thread2.join();
thread3.join();
thread4.join();
...
std::thread thread8( [ this ] {this->spectralClusterer[0].normalizedLaplacian.execute();});
std::thread thread9( [ this ] {this->spectralClusterer[1].normalizedLaplacian.execute();});
std::thread thread10( [ this ] {this->spectralClusterer[2].normalizedLaplacian.execute();});
std::thread thread11( [ this ] {this->spectralClusterer[3].normalizedLaplacian.execute();});
std::thread thread12( [ this ] {this->spectralClusterer[4].normalizedLaplacian.execute();});
std::thread thread13( [ this ] {this->spectralClusterer[5].normalizedLaplacian.execute();});
std::thread thread14( [ this ] {this->spectralClusterer[6].normalizedLaplacian.execute();});
thread8.join();
thread9.join();
thread10.join();
thread11.join();
...
std::thread thread15( [ this ] {this->spectralClusterer[0].eigenSolver.execute();});
std::thread thread16( [ this ] {this->spectralClusterer[1].eigenSolver.execute();});
std::thread thread17( [ this ] {this->spectralClusterer[2].eigenSolver.execute();});
std::thread thread18( [ this ] {this->spectralClusterer[3].eigenSolver.execute();});
std::thread thread19( [ this ] {this->spectralClusterer[4].eigenSolver.execute();});
std::thread thread20( [ this ] {this->spectralClusterer[5].eigenSolver.execute();});
std::thread thread21( [ this ] {this->spectralClusterer[6].eigenSolver.execute();});
thread15.join();
thread16.join();
thread17.join();
thread18.join();
...
std::thread thread22( [ this ] {this->spectralClusterer[0].kMeansClustering.execute();});
std::thread thread23( [ this ] {this->spectralClusterer[1].kMeansClustering.execute();});
std::thread thread24( [ this ] {this->spectralClusterer[2].kMeansClustering.execute();});
std::thread thread25( [ this ] {this->spectralClusterer[3].kMeansClustering.execute();});
std::thread thread26( [ this ] {this->spectralClusterer[4].kMeansClustering.execute();});
std::thread thread27( [ this ] {this->spectralClusterer[5].kMeansClustering.execute();});
std::thread thread28( [ this ] {this->spectralClusterer[6].kMeansClustering.execute();});
thread22.join();
thread23.join();
thread24.join();
thread25.join();
