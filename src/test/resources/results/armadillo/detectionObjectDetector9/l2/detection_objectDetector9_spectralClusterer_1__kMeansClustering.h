...
#ifndef DETECTION_OBJECTDETECTOR9_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#define DETECTION_OBJECTDETECTOR9_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#ifndef M_PI
...
class detection_objectDetector9_spectralClusterer_1__kMeansClustering{
const int n = 2500;
