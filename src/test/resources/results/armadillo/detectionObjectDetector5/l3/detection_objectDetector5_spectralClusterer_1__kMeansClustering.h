...
#ifndef DETECTION_OBJECTDETECTOR5_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#define DETECTION_OBJECTDETECTOR5_SPECTRALCLUSTERER_1__KMEANSCLUSTERING
#ifndef M_PI
...
class detection_objectDetector5_spectralClusterer_1__kMeansClustering{
const int n = 2500;
