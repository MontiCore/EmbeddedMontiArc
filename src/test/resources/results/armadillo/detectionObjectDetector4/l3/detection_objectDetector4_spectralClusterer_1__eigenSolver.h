...
#ifndef DETECTION_OBJECTDETECTOR4_SPECTRALCLUSTERER_1__EIGENSOLVER
#define DETECTION_OBJECTDETECTOR4_SPECTRALCLUSTERER_1__EIGENSOLVER
#ifndef M_PI
...
class detection_objectDetector4_spectralClusterer_1__eigenSolver{
const int n = 2500;
