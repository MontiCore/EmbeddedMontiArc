#ifndef DE_RWTH_ARMIN_MODELING_AUTOPILOT_AUTOPILOT_MOTIONPLANNING_SAC
#define DE_RWTH_ARMIN_MODELING_AUTOPILOT_AUTOPILOT_MOTIONPLANNING_SAC
#ifndef M_PI
...
#include <thread>
class de_rwth_armin_modeling_autopilot_autopilot_motionPlanning_sac{
public:
