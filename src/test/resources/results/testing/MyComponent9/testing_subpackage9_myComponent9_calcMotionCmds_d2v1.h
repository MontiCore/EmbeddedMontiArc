...
#ifndef TESTING_SUBPACKAGE9_MYCOMPONENT9_CALCMOTIONCMDS_D2V1
#define TESTING_SUBPACKAGE9_MYCOMPONENT9_CALCMOTIONCMDS_D2V1
#ifndef M_PI
...
class testing_subpackage9_myComponent9_calcMotionCmds_d2v1{
public:
double distance;
double minVelocity;
double maxVelocity;
