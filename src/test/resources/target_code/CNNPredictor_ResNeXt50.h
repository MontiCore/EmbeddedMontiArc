...
#include <CNNLAOptimizer_ResNeXt50.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_ResNeXt50_0{
public:
    const std::string file_prefix = "model/ResNeXt50/model_0_newest";
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_ResNeXt50 optimizer_creator = CNNLAOptimizer_ResNeXt50();
