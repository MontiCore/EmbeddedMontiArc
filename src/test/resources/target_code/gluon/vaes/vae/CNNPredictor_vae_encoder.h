...
#ifndef CNNPREDICTOR_VAE_ENCODER
#define CNNPREDICTOR_VAE_ENCODER
...
#include <CNNLAOptimizer_vae_encoder.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_vae_encoder_0{
public:
    const std::string file_prefix = "model/vae.Encoder/model_0_newest";
    ...
    explicit CNNPredictor_vae_encoder_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_vae_encoder_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_vae_encoder optimizer_creator = CNNLAOptimizer_vae_encoder();
...
#endif // CNNPREDICTOR_VAE_ENCODER
