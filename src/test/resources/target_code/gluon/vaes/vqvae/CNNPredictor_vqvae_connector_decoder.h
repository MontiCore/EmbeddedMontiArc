...
#ifndef CNNPREDICTOR_VQVAE_CONNECTOR_DECODER
#define CNNPREDICTOR_VQVAE_CONNECTOR_DECODER
...
#include <CNNLAOptimizer_vqvae_connector_decoder.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_vqvae_connector_decoder_0{
public:
    const std::string file_prefix = "model/vqvae.Decoder/model_0_newest";
    ...
    explicit CNNPredictor_vqvae_connector_decoder_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_vqvae_connector_decoder_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_vqvae_connector_decoder optimizer_creator = CNNLAOptimizer_vqvae_connector_decoder();
...
#endif // CNNPREDICTOR_VQVAE_CONNECTOR_DECODER
