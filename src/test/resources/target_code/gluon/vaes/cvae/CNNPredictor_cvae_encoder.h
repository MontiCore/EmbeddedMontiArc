...
#ifndef CNNPREDICTOR_CVAE_ENCODER
#define CNNPREDICTOR_CVAE_ENCODER
...
#include <CNNLAOptimizer_cvae_encoder.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_cvae_encoder_0{
public:
    const std::string file_prefix = "model/cvae.Encoder/model_0_newest";
    ...
    explicit CNNPredictor_cvae_encoder_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_cvae_encoder_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cvae_encoder optimizer_creator = CNNLAOptimizer_cvae_encoder();
...
#endif // CNNPREDICTOR_CVAE_ENCODER
