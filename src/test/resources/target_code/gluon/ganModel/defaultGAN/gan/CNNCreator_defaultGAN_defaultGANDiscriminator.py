...
from CNNDatasets_defaultGAN_defaultGANDiscriminator import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_defaultGAN_defaultGANDiscriminator: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "defaultGAN.DefaultGANDiscriminator")
