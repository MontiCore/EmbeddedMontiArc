...
from CNNDataLoader_defaultGAN_defaultGANDiscriminator import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_defaultGAN_defaultGANDiscriminator: # pylint: disable=invalid-name
    _model_basedir_ = pathlib.Path("model", "defaultGAN.DefaultGANDiscriminator")
