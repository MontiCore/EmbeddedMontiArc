...
from CNNDataLoader_infoGAN_infoGANConnector_predictor import Dataset, TrainingDataset
...
class CNNCreator_infoGAN_infoGANConnector_predictor: # pylint: disable=invalid-name
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 62,), ctx=context[0]), mx.nd.zeros((batch_size, 10,), ctx=context[0]))
