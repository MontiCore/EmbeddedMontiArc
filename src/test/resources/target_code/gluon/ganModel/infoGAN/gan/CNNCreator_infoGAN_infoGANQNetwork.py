...
from CNNDatasets_infoGAN_infoGANQNetwork import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_infoGAN_infoGANQNetwork: # pylint: disable=invalid-name
<<<<<<< HEAD
=======
    _model_basedir_ = pathlib.Path("model", "infoGAN.InfoGANQNetwork")
>>>>>>> origin/master
    ...
    def __init__(self):
        ...
        self.networks = {}
<<<<<<< HEAD
        self._model_basedir_ = pathlib.Path("model", "infoGAN.InfoGANQNetwork")
=======
>>>>>>> origin/master
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 512,4,4,), ctx=context[0]))
