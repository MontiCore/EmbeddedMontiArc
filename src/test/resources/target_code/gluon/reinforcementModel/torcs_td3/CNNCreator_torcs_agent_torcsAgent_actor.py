...
from CNNDatasets_torcs_agent_torcsAgent_actor import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_torcs_agent_torcsAgent_actor: # pylint: disable=invalid-name
<<<<<<< HEAD
=======
    _model_basedir_ = pathlib.Path("model", "torcs.agent.network.TorcsActor")
>>>>>>> origin/master
    ...
    def __init__(self):
        ...
        self.networks = {}
<<<<<<< HEAD
        self._model_basedir_ = pathlib.Path("model", "torcs.agent.network.TorcsActor")
=======
>>>>>>> origin/master
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 29,), ctx=context[0]))
