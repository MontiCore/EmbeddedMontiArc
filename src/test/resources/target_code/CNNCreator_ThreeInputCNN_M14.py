...
from CNNNet_ThreeInputCNN_M14 import Net_0

from CNNDatasets_ThreeInputCNN_M14 import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_ThreeInputCNN_M14: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "ThreeInputCNN_M14")
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 3,200,300,), ctx=context[0]), mx.nd.zeros((batch_size, 3,200,300,), ctx=context[0]), mx.nd.zeros((batch_size, 3,200,300,), ctx=context[0]))
