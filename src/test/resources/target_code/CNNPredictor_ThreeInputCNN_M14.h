...
public:
    const std::string graph_file = "model/ThreeInputCNN_M14/model_cpp_pred.meta";
    const std::string param_prefix = "model/ThreeInputCNN_M14/model_cpp_pred";
    ...
    void predict(const std::vector<float> &data_0_, const std::vector<float> &data_1_, const std::vector<float> &data_2_,
                 std::vector<float> &predictions_){
		

		std::vector<std::string> inputKeys = {"data_0_","data_1_","data_2_"};
		
		
		std::vector<std::vector<float>> inputShapes = {{1,3,200,300},{1,3,200,300},{1,3,200,300}};
		std::vector<tensorflow::TensorShape> inputShapesTensor = {tensorflow::TensorShape({1,3,200,300}),tensorflow::TensorShape({1,3,200,300}),tensorflow::TensorShape({1,3,200,300})};
		
		std::vector<std::vector<float>> inputs =  {data_0_,data_1_,data_2_};
