...
#include <CNNLAOptimizer_CifarClassifierNetwork.h>
...
public:
    ...
    const std::vector<std::vector<mx_uint>> network_input_shapes = {{1, 3, 32, 32}};
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_CifarClassifierNetwork optimizer_creator = CNNLAOptimizer_CifarClassifierNetwork();
