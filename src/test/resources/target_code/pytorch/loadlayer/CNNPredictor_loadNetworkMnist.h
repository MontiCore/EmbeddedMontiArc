...
#ifndef CNNPREDICTOR_LOADNETWORKMNIST_0
#define CNNPREDICTOR_LOADNETWORKMNIST_0
#include <cassert>
#include <string>
#include <vector>
...
class CNNPredictor_loadNetworkMnist_0{
    public:
    const std::string pt_file = "./model/LoadNetworkMnist/model_cpp.pt";
    torch::jit::script::Module module;

    explicit CNNPredictor_loadNetworkMnist_0(){
        init(pt_file);
    }
...
#endif // CNNPREDICTOR_LOADNETWORKMNIST