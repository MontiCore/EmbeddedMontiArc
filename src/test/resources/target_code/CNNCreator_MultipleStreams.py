...
from CNNNet_MultipleStreams import Net_0
from CNNNet_MultipleStreams import Net_1

from CNNDatasets_MultipleStreams import Dataset, TrainingDataset

log = logging.getLogger(__name__)

class CNNCreator_MultipleStreams: # pylint: disable=invalid-name

    def __init__(self):
        self.weight_initializer = mx.init.Normal()
        self.networks = {}
        self._model_basedir_ = pathlib.Path("model", "MultipleStreams")
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 10,), ctx=context[0]))
        ...
        self.networks[1](mx.nd.zeros((batch_size, 10,), ctx=context[0]))
