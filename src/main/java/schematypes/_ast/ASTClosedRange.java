...
public class ASTClosedRange extends ASTClosedRangeTOP {

    public ASTClosedRange() {
    }

    public ASTClosedRange(ASTNumberWithInf min, Optional<ASTNumberWithInf> step, ASTNumberWithInf max, String left, String right) {
