...
public class ASTRightOpenRange extends ASTRightOpenRangeTOP {

    public ASTRightOpenRange() {
    }

    public ASTRightOpenRange(ASTNumberWithInf min, Optional<ASTNumberWithInf> step, ASTNumberWithInf max, String left, String right) {
