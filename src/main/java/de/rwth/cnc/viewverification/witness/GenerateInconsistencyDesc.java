...
public class GenerateInconsistencyDesc {
    ...
    public static String getDescForNotAtomicMismatch(String archName, String viewName, InconsistencyNotAtomic inconsistencyNotAtomic) {
        String desc = "The component " + inconsistencyNotAtomic.getComponentName()
                + " is marked atomic in the view " + viewName + " but is not atomic"
                + " in the C&C model " + archName + ".";
        return desc;
    }
    ...
    public static String getDescForIFCViolation(String archName, String viewName, InconsistencyIFCViolation inconsistencyIFCViolation) {
        String desc = "The port " + inconsistencyIFCViolation.getPortName()
                + " is not part of the component "
                + inconsistencyIFCViolation.getComponentName()
                + " which is marked as interface-complete in the view "
                + viewName + ".";
        return desc;
    }
}
