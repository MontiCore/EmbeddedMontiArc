...
public class IdGenerator {
    ...
    /**
     * The maximum ID handed out. Not reset between simulations to keep IDs even
     * between different simulations unique.
     */
    ...
    /**
     * Generates a positive ID that is unique in the simulation. If the simulator is
     * reset, the IDs are not given out a second time. 0 is invalid.
     *
