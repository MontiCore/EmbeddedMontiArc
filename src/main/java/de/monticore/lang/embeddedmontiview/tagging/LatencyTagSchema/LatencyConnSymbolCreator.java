 ...
 */
public class LatencyConnSymbolCreator implements TagSymbolCreator {
      ...
      element.getTagElements().stream()
          ...
          .forEachOrdered(v ->
              element.getScopes().stream()
                ...
                .map(this::checkKind)
                .filter(s -> s != null)
                .forEachOrdered(s -> s.addTag(new LatencyConnSymbol(
  ...
  protected boolean checkScope(ASTScope scope) {
    ...
    Log.error(String.format("0xT0005 Invalid scope kind: '%s'. LatencyConn expects as scope kind 'ConnectorScope'.",
