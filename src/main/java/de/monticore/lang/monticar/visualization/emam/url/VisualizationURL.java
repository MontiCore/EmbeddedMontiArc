...
public class VisualizationURL implements URLContribution {
    ...
    public void addToRegistry(URLService registry) throws MalformedURLException {
        registry.addURL("visualization.zip", new URL("https://rwth-aachen.sciebo.de/s/igDWzLpdO5zYHBj/download?path=%2Fshared%2F18.06.20.visualisation&files=visualisation.zip"));
    }
}
