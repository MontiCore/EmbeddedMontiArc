 ...
 *******************************************************************************/
package de.monticore.lang.monticar.generator.middleware.helpers.AffinityPropagationHelper.clust4j.log;

import static de.monticore.lang.monticar.generator.middleware.helpers.AffinityPropagationHelper.clust4j.log.Log.Tag.*;
	...
	private static void write0(final LogEvent e, final boolean printOnOut) {
		...
		//synchronized(Event.class) {
			if((null == l4j) && !loggerCreateWasCalled) {
				...
				final URI root = LogProperties.getRoot();
				...
				if(windowsPath)
					...
					dir = new File(LogProperties.DEFAULT_ROOT());
