...
public class CheckAdaNetPathToFilesExists extends CNNArchSymbolCoCo {
    ...
    public void check(ArchitectureSymbol architecture) {
        if (architecture.containsAdaNet() && (architecture.getAdaNetUtils().equals("./src/main/resources/AdaNet/") || architecture.getAdaNetUtils().equals("./target/generated-sources-emadl/" + "/AdaNet/"))) {
