...
public class ArchitectureSymbol extends CommonScopeSpanningSymbol {
    ...
    public void setCustomPyFilesPath(String customPyFilesPath) {
        this.customPyFilesPath = customPyFilesPath;
    }

    public String getCustomPyFilesPath() {
        return customPyFilesPath;
    }
