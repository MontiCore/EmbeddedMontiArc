...
public class CNNArchTemplateController {
    ...
    public static final String CNNARCH_TEMPLATE_PATH = "CNNArch/";
    ...
    public CNNArchTemplateController(ArchitectureSymbol architecture, Target target) {
    ...
    public void include(String relativePath, String templateWithoutFileEnding, Writer stringWriter){
        String templatePath = CNNARCH_TEMPLATE_PATH + relativePath + templateWithoutFileEnding + FTL_FILE_ENDING;
