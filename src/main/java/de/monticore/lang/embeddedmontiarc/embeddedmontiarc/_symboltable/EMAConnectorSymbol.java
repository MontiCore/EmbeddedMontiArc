 ...
 */
public class EMAConnectorSymbol extends CommonSymbol implements EMAElementInstanceSymbol {
    ...
    protected EMAPortSymbol getPort(String name, boolean isSourcePortName) {
        ...
        if (this.getEnclosingScope().getSpanningSymbol()
            ...
            Log.info("Connector is embedded in EMAComponentInstanceSymbol", "EMAConnectorSymbol:");
