...
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  ...
  { // empty body 
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_225 Parameter 'visitor' must not be null.");
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_317 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof weather._visitor.WeatherVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_412AST node type ASTOpticalPhenomena of the sub language Weather expected a visitor of type weather._visitor.WeatherVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
    ...
    return o instanceof ASTOpticalPhenomena;
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_734 Parameter 'child' must not be null.");
   ...
   public  ASTOpticalPhenomena deepClone(ASTOpticalPhenomena result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_540 Parameter 'result' must not be null.");
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_646 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_104 Parameter 'baseClass' must not be null.");
 ...
 /**
  ...
  public static class Builder  {
    public ASTOpticalPhenomena build() {
      return new ASTOpticalPhenomena (/* generated by template ast.ParametersDeclaration*/
    // Parameters declaration
