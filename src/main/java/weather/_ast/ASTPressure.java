...
import org.eclipse.emf.ecore.util.EObjectContainmentEList;
 ...
 public  class ASTPressure extends /* generated by template ast.AstSuperTypes*/
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  /* generated by template ast.Attribute*/
  
   protected  si._ast.ASTUnitNumber weatherPressure;

    /* generated by template ast.Constructor*/
  
   protected  ASTPressure (/* generated by template ast.ParametersDeclaration*/
  ...
  { // empty body 
   ...
   protected  ASTPressure (/* generated by template ast.ConstructorParametersDeclaration*/
     si._ast.ASTUnitNumber weatherPressure 
 
    )  
  /* generated by template ast.ConstructorAttributesSetter*/
  {
    setWeatherPressure(weatherPressure);
  }
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_006 Parameter 'visitor' must not be null.");
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_880 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof weather._visitor.WeatherVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_723AST node type ASTPressure of the sub language Weather expected a visitor of type weather._visitor.WeatherVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
    ...
    // comparing weatherPressure
    if ( (this.weatherPressure == null && comp.weatherPressure != null) || 
      (this.weatherPressure != null && !this.weatherPressure.deepEquals(comp.weatherPressure)) ) {
      return false;
    }
    return true;     
   ...
   public  boolean deepEquals(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_180 Parameter 'o' must not be null.");
   ...
   public  boolean deepEqualsWithComments(Object o,boolean forceSameOrder)   { 
    ...
    // comparing weatherPressure
    if ( (this.weatherPressure == null && comp.weatherPressure != null) || 
      (this.weatherPressure != null && !this.weatherPressure.deepEqualsWithComments(comp.weatherPressure)) ) {
      return false;
    }
    return true;     
   ...
   public  boolean deepEqualsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_844 Parameter 'o' must not be null.");
   ...
   public  boolean equalAttributes(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_797 Parameter 'o' must not be null.");

     /* generated by template ast.additionalmethods.EqualAttributes*/

    return o instanceof ASTPressure;
   ...
   public  boolean equalsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_305 Parameter 'o' must not be null.");
   ...
   public  java.util.Collection<de.monticore.ast.ASTNode> get_Children()   { 
    ...
    java.util.LinkedList<de.monticore.ast.ASTNode> result = new java.util.LinkedList<de.monticore.ast.ASTNode>();
        if ( getWeatherPressure() != null ) {
          result.add(getWeatherPressure());
        }
    return result;
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_107 Parameter 'child' must not be null.");

     /* generated by template ast.additionalmethods.RemoveChild*/

      if (getWeatherPressure() == child) {
        setWeatherPressure(null);
      }
   ...
   public  ASTPressure deepClone(ASTPressure result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_472 Parameter 'result' must not be null.");

     /* generated by template ast.additionalmethods.DeepCloneWithParameters*/
  
    super.deepClone(result);
    
    result.setWeatherPressure((si._ast.ASTUnitNumber) this.weatherPressure.deepClone());
   ...
   protected  ASTPressure _construct()   { 
   ...
   public  si._ast.ASTUnitNumber getWeatherPressure()   { 
   ...
   public  void setWeatherPressure(si._ast.ASTUnitNumber weatherPressure)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(weatherPressure, "0xA7006_669 Parameter 'weatherPressure' must not be null.");

     /* generated by template ast_emf.additionalmethods.Set*/

    si._ast.ASTUnitNumber oldWeatherPressure = this.weatherPressure;
    this.weatherPressure = weatherPressure;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, WeatherPackage.ASTPressure_WeatherPressure, oldWeatherPressure, weatherPressure));
    }  
   ...
   public  Object eGet(int featureID,boolean resolve,boolean coreType)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTPressure_WeatherPressure:
         return getWeatherPressure();
    }
   ...
   public  void eSet(int featureID,Object newValue)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTPressure_WeatherPressure:
        setWeatherPressure((si._ast.ASTUnitNumber)newValue);
        return;
    }
   ...
   public  boolean eIsSet(int featureID)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTPressure_WeatherPressure:
        return getWeatherPressure() != null;
    }
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_046 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_252 Parameter 'baseClass' must not be null.");
   ...
   protected  EClass eStaticClass()   { 
     ...
     return WeatherPackage.Literals.ASTPressure;
  } 
 ...
 /**
   * Builder for {@link ASTPressure}.
   */
  public static class Builder  {
    /* generated by template ast.BuilderAttribute*/
     protected  si._ast.ASTUnitNumber weatherPressure;

    public ASTPressure build() {
      return new ASTPressure (/* generated by template ast.BuilderConstructorParametersDeclaration*/
    ...
    public Builder weatherPressure(si._ast.ASTUnitNumber weatherPressure) {
      this.weatherPressure = weatherPressure;
      return this;
    }
