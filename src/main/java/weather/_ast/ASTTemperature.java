...
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  /* generated by template ast.Attribute*/
   ...
   protected  si._ast.ASTUnitNumber weatherTemperature;
  ...
  { // empty body 
   ...
   protected  ASTTemperature (/* generated by template ast.ConstructorParametersDeclaration*/
     si._ast.ASTUnitNumber weatherTemperature 
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_589 Parameter 'visitor' must not be null.");
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_035 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof weather._visitor.WeatherVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_852AST node type ASTTemperature of the sub language Weather expected a visitor of type weather._visitor.WeatherVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_144 Parameter 'o' must not be null.");
    ...
    if ( (this.weatherTemperature == null && comp.weatherTemperature != null) || 
      (this.weatherTemperature != null && !this.weatherTemperature.deepEquals(comp.weatherTemperature)) ) {
      return false;
    }
    return true;     
   ...
   public  boolean deepEqualsWithComments(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_165 Parameter 'o' must not be null.");
    ...
    // comparing weatherTemperature
    if ( (this.weatherTemperature == null && comp.weatherTemperature != null) || 
      (this.weatherTemperature != null && !this.weatherTemperature.deepEqualsWithComments(comp.weatherTemperature)) ) {
      return false;
    }
    return true;     
   ...
   public  boolean equalAttributes(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_516 Parameter 'o' must not be null.");

     /* generated by template ast.additionalmethods.EqualAttributes*/

    return o instanceof ASTTemperature;
   ...
   public  java.util.Collection<de.monticore.ast.ASTNode> get_Children()   { 
    ...
    java.util.LinkedList<de.monticore.ast.ASTNode> result = new java.util.LinkedList<de.monticore.ast.ASTNode>();
        if ( getWeatherTemperature() != null ) {
          result.add(getWeatherTemperature());
        }
    return result;
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_426 Parameter 'child' must not be null.");

     /* generated by template ast.additionalmethods.RemoveChild*/

      if (getWeatherTemperature() == child) {
   ...
   public  ASTTemperature deepClone(ASTTemperature result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_699 Parameter 'result' must not be null.");

     /* generated by template ast.additionalmethods.DeepCloneWithParameters*/
  
    super.deepClone(result);
    
    result.setWeatherTemperature((si._ast.ASTUnitNumber) this.weatherTemperature.deepClone());
   ...
   public  si._ast.ASTUnitNumber getWeatherTemperature()   { 
   ...
   public  void setWeatherTemperature(si._ast.ASTUnitNumber weatherTemperature)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(weatherTemperature, "0xA7006_305 Parameter 'weatherTemperature' must not be null.");

     /* generated by template ast_emf.additionalmethods.Set*/

    si._ast.ASTUnitNumber oldWeatherTemperature = this.weatherTemperature;
   ...
   public  void eSet(int featureID,Object newValue)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTTemperature_WeatherTemperature:
        setWeatherTemperature((si._ast.ASTUnitNumber)newValue);
        return;
    }
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_615 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_067 Parameter 'baseClass' must not be null.");
 ...
 /**
  ...
  public static class Builder  {
    ...
    public Builder weatherTemperature(si._ast.ASTUnitNumber weatherTemperature) {
      this.weatherTemperature = weatherTemperature;
      return this;
    }
