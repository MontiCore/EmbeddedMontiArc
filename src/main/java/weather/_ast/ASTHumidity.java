...
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  /* generated by template ast.Attribute*/
   ...
   protected  si._ast.ASTUnitNumber weatherHumidity;
  ...
  { // empty body 
   ...
   protected  ASTHumidity (/* generated by template ast.ConstructorParametersDeclaration*/
     si._ast.ASTUnitNumber weatherHumidity 
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
    ...
    if (visitor instanceof weather._visitor.WeatherVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_658AST node type ASTHumidity of the sub language Weather expected a visitor of type weather._visitor.WeatherVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_801 Parameter 'o' must not be null.");
    ...
    if ( (this.weatherHumidity == null && comp.weatherHumidity != null) || 
      (this.weatherHumidity != null && !this.weatherHumidity.deepEquals(comp.weatherHumidity)) ) {
      return false;
    }
    return true;     
   ...
   public  boolean deepEquals(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_698 Parameter 'o' must not be null.");
   ...
   public  boolean deepEqualsWithComments(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_835 Parameter 'o' must not be null.");
    ...
    // comparing weatherHumidity
    if ( (this.weatherHumidity == null && comp.weatherHumidity != null) || 
      (this.weatherHumidity != null && !this.weatherHumidity.deepEqualsWithComments(comp.weatherHumidity)) ) {
      return false;
    }
    return true;     
   ...
   public  boolean deepEqualsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_482 Parameter 'o' must not be null.");
   ...
   public  boolean equalAttributes(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_053 Parameter 'o' must not be null.");

     /* generated by template ast.additionalmethods.EqualAttributes*/

    return o instanceof ASTHumidity;
   ...
   public  java.util.Collection<de.monticore.ast.ASTNode> get_Children()   { 
    ...
    java.util.LinkedList<de.monticore.ast.ASTNode> result = new java.util.LinkedList<de.monticore.ast.ASTNode>();
        if ( getWeatherHumidity() != null ) {
          result.add(getWeatherHumidity());
        }
    return result;
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_165 Parameter 'child' must not be null.");

     /* generated by template ast.additionalmethods.RemoveChild*/

      if (getWeatherHumidity() == child) {
   ...
   public  ASTHumidity deepClone(ASTHumidity result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_525 Parameter 'result' must not be null.");

     /* generated by template ast.additionalmethods.DeepCloneWithParameters*/
  
    super.deepClone(result);
    
    result.setWeatherHumidity((si._ast.ASTUnitNumber) this.weatherHumidity.deepClone());
   ...
   public  si._ast.ASTUnitNumber getWeatherHumidity()   { 
   ...
   public  void setWeatherHumidity(si._ast.ASTUnitNumber weatherHumidity)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(weatherHumidity, "0xA7006_731 Parameter 'weatherHumidity' must not be null.");

     /* generated by template ast_emf.additionalmethods.Set*/

    si._ast.ASTUnitNumber oldWeatherHumidity = this.weatherHumidity;
   ...
   public  void eSet(int featureID,Object newValue)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTHumidity_WeatherHumidity:
        setWeatherHumidity((si._ast.ASTUnitNumber)newValue);
        return;
    }
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_765 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_983 Parameter 'baseClass' must not be null.");
 ...
 /**
  ...
  public static class Builder  {
    ...
    public Builder weatherHumidity(si._ast.ASTUnitNumber weatherHumidity) {
      this.weatherHumidity = weatherHumidity;
      return this;
    }
