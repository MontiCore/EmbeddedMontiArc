...
def translate_optim_name(model_param, optim_param):
    optim_name = optim_param.get_Optimizer_type_Value()
    mapping = {
        "sgd":               torch.optim.SGD(model_param, lr=optim_param.getoptimizer_typelearning_rate()),
        "adam":              torch.optim.Adam(model_param, lr=optim_param.getoptimizer_typelearning_rate())
