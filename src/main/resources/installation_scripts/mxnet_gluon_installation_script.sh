...
python get-pip.py
python -m pip install --user h5py matplotlib numpy==1.16.5 mxnet==1.5.1.post0 #The newest version installed the current standard version installed v1.7.0 cant be run with python2 the current standard of the EMDAL2CPP generator,
...
cd .. #return back to the directory in which the command was executed
