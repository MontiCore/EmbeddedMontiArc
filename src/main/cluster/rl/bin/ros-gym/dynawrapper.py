...
log_file = os.path.join(project_root, 'logs', 'dynawrapper.log')
...
class DynaWrapper(object):
    ...
    def simulate(self):
        ...
        logging.write("Starting simulate \n")
        ...
        logging.write("Written to preprocessing: " + materialString + "\n")
        shutil.copyfile(input_preprocessing, input_file)
        logging.write("Copied Input.csv to files \n")
        logging.flush()
        ...
        logging.write("RL received dyna output \n")
        logging.flush()
        subprocess.run(['make', 'preprocessing'], cwd=project_root)
        logging.write("Preprocessing finished \n")
        ...
        logging.write("force is: " + str(self.force) + "\n")
        logging.write("distance is: " + str(self.distance) + "\n")
        subprocess.run(['make', 'clean'], cwd=project_root)
        logging.write("Clean finished, continue RL \n")
        logging.close()

    def integrate(self):
        logging = open(log_file, 'a')
        logging.write("integrate \n")
        logging.close()
    ...
    def getFinalLevel(self):
        ...
        logging.write("final level with peakpos: " + str(peak_pos) + "\n")
        logging.close()
    ...
    def updateMaterial(self, material):
        logging = open(log_file, 'a')
        logging.write("Update material: " + str(material) + "\n")
        logging.close()
        self.material = material
