...
class CNNSupervisedTrainer_rnnsearch_main_net:
        ...
        for epoch in range(begin_epoch, begin_epoch + num_epoch):
            ...
            for batch_i, batch in enumerate(train_iter):
                ...
                with autograd.record():
                    ...
                    const1_ = mx.nd.full((batch_size, 1,), 2, ctx=mx_context)
                ...
                if True: 
                    ...
                    for i in range(1, 30):
                        ...
                        for seq, score in sequences:
                            ...
                            for j in topk:
                                candidate = (seq + [mx.nd.full((1, 1,), j, ctx=mx_context)], score * mx.nd.softmax(out[0][j]).asscalar())
            ...
            logging.info("Loss Epoch[%d], Train Loss: %f, Test Loss: %f" % (epoch, global_loss_train, global_loss_test))
