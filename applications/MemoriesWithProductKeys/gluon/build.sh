...
rm -rf target
java -jar ../embedded-montiarc-emadl-generator-0.4.3-SNAPSHOT-jar-with-dependencies.jar -m src/emadl/models/ -r memorieswithproductkeys.Connector -o target -b GLUON -f n -p /usr/bin/python3
