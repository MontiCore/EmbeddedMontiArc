...
class BertExporter:
    ...
    def loadModel(self):
        self.model, self.vocab = nlp.model.get_model(self.model_type, dataset_name=self.dataset, pretrained=True, use_pooler=False, use_classifier=False, use_decoder=False)
        print("Model loaded!")
