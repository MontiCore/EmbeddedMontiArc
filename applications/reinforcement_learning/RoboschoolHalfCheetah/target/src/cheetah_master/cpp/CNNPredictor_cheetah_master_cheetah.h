#ifndef CNNPREDICTOR_CHEETAH_MASTER_CHEETAH
#define CNNPREDICTOR_CHEETAH_MASTER_CHEETAH
...
class CNNPredictor_cheetah_master_cheetah_0{
public:
    const std::string json_file = "model/cheetah.agent.CheetahActor/model_0_newest-symbol.json";
    const std::string param_file = "model/cheetah.agent.CheetahActor/model_0_newest-0000.params";
    const std::vector<std::string> input_keys = {
        "data"
    };
    const std::vector<std::vector<mx_uint>> input_shapes = {{1, 26}};
    const bool use_gpu = false;

    PredictorHandle handle;

    explicit CNNPredictor_cheetah_master_cheetah_0(){
        init(json_file, param_file, input_keys, input_shapes, use_gpu);
    }

    ~CNNPredictor_cheetah_master_cheetah_0(){
...
#endif // CNNPREDICTOR_CHEETAH_MASTER_CHEETAH
