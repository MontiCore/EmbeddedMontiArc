...
import logging
import os
from CNNNet_cheetah_master_cheetah import Net_0

class CNNCreator_cheetah_master_cheetah:
    _model_dir_ = "model/cheetah.agent.CheetahActor/"
    ...
    def construct(self, context, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((1, 26,), ctx=context))
