...
# install mxnet pypi
pip install pyprind h5py matplotlib numpy mxnet==1.9.1
...
mkdir build && cd build && cmake -DUSE_CPP_PACKAGE=1 -DUSE_CUDA=0 -DUSE_OPENCV=0 -DBUILD_CPP_EXAMPLES=0 -DUSE_OPERATOR_TUNING=1 -DUSE_GPERFTOOLS=0 -DUSE_JEMALLOC=0 -DUSE_SSE=1 -DUSE_F16C=0 -GNinja .. && ninja && cd ..
