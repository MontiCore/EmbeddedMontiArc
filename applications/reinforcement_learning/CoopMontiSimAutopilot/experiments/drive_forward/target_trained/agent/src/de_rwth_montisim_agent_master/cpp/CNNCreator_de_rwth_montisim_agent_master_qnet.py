...
from CNNNet_de_rwth_montisim_agent_master_qnet import Net_0

class CNNCreator_de_rwth_montisim_agent_master_qnet:
    _model_dir_ = "model/de.rwth.montisim.agent.network.AutopilotQNet/"
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 25,), ctx=context[0]))
