...
from CNNNet_de_rwth_montisim_agent_network_autopilotCritic import Net_0

class CNNCreator_de_rwth_montisim_agent_network_autopilotCritic:
    _model_dir_ = "model/de.rwth.montisim.agent.network.AutopilotCritic/"
    ...
    def construct(self, context, batch_size=1, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((batch_size, 80,), ctx=context[0]), mx.nd.zeros((batch_size, 3,), ctx=context[0]))
