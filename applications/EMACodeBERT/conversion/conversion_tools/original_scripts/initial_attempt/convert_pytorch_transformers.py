...
####################################################################
# convert vocabulary
vocab = tf_vocab_to_gluon_vocab(load_text_vocab(os.path.join(dir_name, 'vocab.json')))
# vocab serialization
...
encoder = nlp.model.TransformerEncoder(#attention_cell=predefined_args['attention_cell'],
