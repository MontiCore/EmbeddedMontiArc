# this was taken from https://github.com/dmlc/gluon-nlp/blob/2bc75db7ae64f8fbb077c08f3b44bc93898090d8/scripts/conversion_toolkits/convert_fairseq_roberta.py
# it is a conversion script for converting fairseq roberta to gluonnlp
# Library Versions: gluonnlp 1.0.0.dev20210116, fairseq 1.0.0a0+4a6f89d, mxnet 2.0.0b20210116, torch 1.4.0, transformers 4.2.1
...
def test_model(fairseq_model, gluon_model, gpu):
    ...
    fs_input_ids = torch.from_numpy(input_ids).cpu()
...
def convert_fairseq_model(args):
    ...
    gluon_cfg = convert_config(fairseq_roberta.cfg.model, vocab_size, RobertaModel.get_cfg().clone())
