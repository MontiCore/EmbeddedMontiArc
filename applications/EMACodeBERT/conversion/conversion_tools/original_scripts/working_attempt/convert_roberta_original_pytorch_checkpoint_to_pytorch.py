...
# this was taken from the huggingface github repository, it is a script for converting fairseq roberta to huggingface roberta
# taken from https://github.com/huggingface/transformers/blob/b399c26446ea833ab6e9f968fce6fa95c97c6906/src/transformers/convert_roberta_original_pytorch_checkpoint_to_pytorch.py
