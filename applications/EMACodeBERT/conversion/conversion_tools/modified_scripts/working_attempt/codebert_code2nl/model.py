...
'''
This script was taken from https://github.com/microsoft/CodeBERT/tree/master/CodeBERT/code2nl
'''
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, source_ids=None,source_mask=None,target_ids=None,target_mask=None,args=None):   
        ...
        if target_ids is not None:  
            ...
            outputs = loss,loss*active_loss.sum(),active_loss.sum(), shift_logits.detach()
            return outputs
        else:
            #Predict 
            preds=[]
            ...
            #TODO changed by makua, returns output probs to compare models
