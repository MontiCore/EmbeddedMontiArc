...
#                       COMPARE OUTPUTS                            #
####################################################################
text = 'this is my best test sentence'
...
print('\npytorch shape: ', last_hidden_states.size())

gluon_numpy_out = seq_encoding.asnumpy()
pytorch_numpy_out = last_hidden_states.detach().numpy()

mx.nd.waitall()
mx.test_utils.assert_almost_equal(gluon_numpy_out, pytorch_numpy_out, atol=1e-3, rtol=1e-3)
mx.test_utils.assert_almost_equal(gluon_numpy_out, pytorch_numpy_out, atol=1e-5, rtol=1e-5)
