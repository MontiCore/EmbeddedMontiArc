...
ckpt = torch.load(os.path.join(ckpt_dir, 'model.pt'), map_location=torch.device('cpu'))
...
print(visited_pytorch_params)
print([pytorch_params.keys()])
...
mx_out = bert(mx.nd.array([mx_data]), None)
