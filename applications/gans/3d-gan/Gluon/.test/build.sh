...
echo $MXNET_FOLDER
export PYTHONPATH="/builds/monticore/EmbeddedMontiArc/applications/gans/3d-gan/Gluon/.test/target/gan"
...
rm -rf target
java -jar ../embedded-montiarc-emadl-generator-0.5.3-SNAPSHOT-jar-with-dependencies.jar -m src/emadl/models -r threedgan.Connector -o target -b GLUON
