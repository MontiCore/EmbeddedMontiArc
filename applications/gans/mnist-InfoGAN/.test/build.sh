...
rm -rf target
java -jar ../embedded-montiarc-emadl-generator-0.4.0-jar-with-dependencies.jar -m src/emadl/models/ -r mnistGenerator.Connector -o target -b GLUON

rm -rf build
mkdir build && cd build

echo "Building MNISTGenerator.."
