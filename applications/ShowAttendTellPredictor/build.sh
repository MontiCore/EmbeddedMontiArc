...
rm -rf target
java -jar embedded-montiarc-emadl-generator-0.3.7-SNAPSHOT-jar-with-dependencies.jar -m src/emadl/models/ -r showAttendTell.Main -o target -b GLUON

rm -rf build
mkdir build && cd build

echo "Building ShowAttendTell.."
