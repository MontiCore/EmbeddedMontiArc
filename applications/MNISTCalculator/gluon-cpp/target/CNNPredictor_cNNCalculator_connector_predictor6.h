#ifndef CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR6
#define CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR6
...
#include <CNNLAOptimizer_cNNCalculator_connector_predictor6.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_cNNCalculator_connector_predictor6_0{
public:
    ...
    explicit CNNPredictor_cNNCalculator_connector_predictor6_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_cNNCalculator_connector_predictor6_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cNNCalculator_connector_predictor6 optimizer_creator = CNNLAOptimizer_cNNCalculator_connector_predictor6();
...
#endif // CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR6
