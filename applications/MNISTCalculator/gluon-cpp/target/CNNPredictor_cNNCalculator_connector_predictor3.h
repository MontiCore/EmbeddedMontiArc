#ifndef CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR3
#define CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR3
...
#include <CNNLAOptimizer_cNNCalculator_connector_predictor3.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_cNNCalculator_connector_predictor3_0{
public:
    ...
    explicit CNNPredictor_cNNCalculator_connector_predictor3_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_cNNCalculator_connector_predictor3_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cNNCalculator_connector_predictor3 optimizer_creator = CNNLAOptimizer_cNNCalculator_connector_predictor3();
...
#endif // CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR3
