...
#include <CNNLAOptimizer_cNNCalculator_connector_predictor5.h>
...
public:
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cNNCalculator_connector_predictor5 optimizer_creator = CNNLAOptimizer_cNNCalculator_connector_predictor5();
