#ifndef CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR1
#define CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR1
...
#include <CNNLAOptimizer_cNNCalculator_connector_predictor1.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_cNNCalculator_connector_predictor1_0{
public:
    ...
    explicit CNNPredictor_cNNCalculator_connector_predictor1_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_cNNCalculator_connector_predictor1_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cNNCalculator_connector_predictor1 optimizer_creator = CNNLAOptimizer_cNNCalculator_connector_predictor1();
...
#endif // CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR1
