#ifndef CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR2
#define CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR2
...
#include <CNNLAOptimizer_cNNCalculator_connector_predictor2.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_cNNCalculator_connector_predictor2_0{
public:
    ...
    explicit CNNPredictor_cNNCalculator_connector_predictor2_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_cNNCalculator_connector_predictor2_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cNNCalculator_connector_predictor2 optimizer_creator = CNNLAOptimizer_cNNCalculator_connector_predictor2();
...
#endif // CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR2
