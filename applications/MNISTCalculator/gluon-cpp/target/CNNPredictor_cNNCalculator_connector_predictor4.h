#ifndef CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR4
#define CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR4
...
#include <CNNLAOptimizer_cNNCalculator_connector_predictor4.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_cNNCalculator_connector_predictor4_0{
public:
    ...
    explicit CNNPredictor_cNNCalculator_connector_predictor4_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_cNNCalculator_connector_predictor4_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_cNNCalculator_connector_predictor4 optimizer_creator = CNNLAOptimizer_cNNCalculator_connector_predictor4();
...
#endif // CNNPREDICTOR_CNNCALCULATOR_CONNECTOR_PREDICTOR4
