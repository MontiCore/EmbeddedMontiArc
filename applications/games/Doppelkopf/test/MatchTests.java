...
public class MatchTests implements GDLTest.TestImpl {
    ...
    @Test
    public void testDoppelkopf() {
        File testDir = new File("MatchTests/Doppelkopf");
    ...
    @Test
    public void testDoppelkopfReducedTyped() {
        File testDir = new File("MatchTests/DoppelkopfReducedTyped");
        for (File testFile : testDir.listFiles()) {
            doTestForFile(testFile);
        }
    }
    ...
    @Test
    public void testDoppelkopfTyped() {
        File testDir = new File("MatchTests/DoppelkopfTyped");
        for (File testFile : testDir.listFiles()) {
            doTestForFile(testFile);
        }
    }
