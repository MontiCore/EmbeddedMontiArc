...
from CNNNet_cNNCalculator_connector_predictor5 import Net_0

class CNNCreator_cNNCalculator_connector_predictor5:
    ...
    def construct(self, context, data_mean=None, data_std=None):
        ...
        if hasattr(self.networks[0], "replaysubnet0_"):
            self.networks[0].replaysubnet0_(mx.nd.zeros((1, 1,28,28,), ctx=context))
