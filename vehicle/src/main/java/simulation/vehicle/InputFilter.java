...
/**
 * Contains a inputFilter.fmu and provides methods to safely interact with the fmu.
 */
public class InputFilter {

    /** FMU that is represented with this class*/
    private Simulation inputFilter;

    /** Flag whether the FMU has been initialized */
    private boolean isInitialized = false;

    /** Flag whether the FMU has been terminated */
    ...
    /**
     * Function that initialized the inputFilter FMU
    ...
    /**
     * Function that terminated the computation
     */
    ...
    /**
     * Function that returns if the computation is terminated
     * @return Value of isTerminated
     */
    public boolean isTerminated(){
        isTerminated = inputFilter.isTerminated();
        return isTerminated;
    }

    /**
     * Function that returns the inputFilter FMU
     * @return InputFilter FMU
     */
