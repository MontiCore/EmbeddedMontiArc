...
/**
 * Contains a chassis.fmu and provides methods to safely interact with the fmu.
 */
public class Chassis {
    ...
    /**
     * Function that initialized the chassis FMU
    ...
    public boolean isTerminated(){
        isTerminated = chassis.isTerminated();
        return isTerminated;
    }

    /**
     * Function that returns the chassis FMU
     * @return Chassis FMU
     */
