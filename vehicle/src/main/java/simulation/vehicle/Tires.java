...
/**
 * Contains a tires.fmu and provides methods to safely interact with the fmu.
 */
public class Tires {
    ...
    /**
     * Function that initialized the tires FMU
    ...
    public boolean isTerminated(){
        isTerminated = tires.isTerminated();
        return isTerminated;
    }

    /**
     * Function that returns the tires FMU
     * @return Tires FMU
     */
