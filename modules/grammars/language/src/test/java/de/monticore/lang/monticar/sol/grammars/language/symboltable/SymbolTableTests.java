...
public class SymbolTableTests {
    ...
    void testSymbolTable() {
        ...
        List<TemplateUndeclarationSymbol> localUndeclarations = symbol.getLocalUndeclarationSymbols();
        ...
        assertEquals(3, options.get(2).getSubOptions().size(), "There should be exactly 3 sub-options.");
