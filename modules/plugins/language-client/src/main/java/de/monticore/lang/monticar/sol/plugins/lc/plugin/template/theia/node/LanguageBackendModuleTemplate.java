...
@Singleton
public class LanguageBackendModuleTemplate extends AbstractTemplateContribution {
    protected final LanguageClientConfiguration configuration;

    @Inject
    protected LanguageBackendModuleTemplate(LanguageClientConfiguration configuration, HandCodeService handCode) {
        super(handCode);
    ...
    public String getTemplatePath() {
        return "templates/language-client/theia/src/node/language-backend-module.ftl";
    }
    ...
    public Path getOutputPath() {
        ...
        return Paths.get(String.format("node/%s-backend-module.ts", grammarName));
    }
}
