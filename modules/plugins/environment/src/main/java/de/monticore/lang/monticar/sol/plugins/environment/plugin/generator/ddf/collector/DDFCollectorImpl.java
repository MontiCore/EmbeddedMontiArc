 ...
 */
package de.monticore.lang.monticar.sol.plugins.environment.plugin.generator.ddf.collector;
...
@Singleton
public class DDFCollectorImpl implements DDFCollector, EnvironmentInheritanceVisitor {
    ...
    @Inject
    protected DDFCollectorImpl(NotificationService notifications, EnvironmentSymbolTable symbolTable) {
