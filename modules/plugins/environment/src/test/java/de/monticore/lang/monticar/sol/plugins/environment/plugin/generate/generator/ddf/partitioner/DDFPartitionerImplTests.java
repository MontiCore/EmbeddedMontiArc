 ...
 */
package de.monticore.lang.monticar.sol.plugins.environment.plugin.generate.generator.ddf.partitioner;

import de.monticore.lang.monticar.sol.grammars.environment._ast.ASTArgInstruction;
...
public class DDFPartitionerImplTests {
    @Mock NotificationService notifications;

    @InjectMocks DDFPartitionerImpl partitioner;

    List<ASTInstruction> instructions = new ArrayList<>();

    @BeforeEach
    void before() {
        ASTArgInstruction arg = mock(ASTArgInstruction.class);
        ASTInstallInstruction installation = mock(ASTInstallInstruction.class);
        ASTEnvInstruction env = mock(ASTEnvInstruction.class);
