...
public class NoDuplicatePackageTests {
    ...
    void before() {
        ...
        ASTInstallInstruction firstInstall = EnvironmentMill.installInstructionBuilder()
                .addPackage(cmake).addPackage(buildEssential).build();

        ASTInstallInstruction secondInstall = EnvironmentMill.installInstructionBuilder()
