...
define(function(require, exports, module) {
    ...
    var langClasses = (
        ...
        "NullPointerException|Long|Integer|Short|Byte|Double|Float|"+
        ...
        "for|end|elseif|else|if|script"
    );

    var HighlightRules = require("plugins/se.rwth.api.language/modes/language_highlight_rules");

    exports.MathHighlightRules =
        HighlightRules("MontiMath", keywords, buildInConstants, langClasses);
});
