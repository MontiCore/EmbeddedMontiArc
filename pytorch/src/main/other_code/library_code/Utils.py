...
def translate_optim_name(model_param, optim_param):
    optim_name = optim_param.getoptimizerValue()
    mapping = {
        "sgd":               torch.optim.SGD(model_param, lr=optim_param.getlearning_rate()),
        "adam":              torch.optim.Adam(model_param, lr=optim_param.getlearning_rate())
