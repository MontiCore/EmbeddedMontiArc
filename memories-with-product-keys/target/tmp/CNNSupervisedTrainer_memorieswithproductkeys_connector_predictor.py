...
class CNNSupervisedTrainer_memorieswithproductkeys_connector_predictor:
    ...
    def train(self, batch_size=64,
        ...
        if preprocessing:
            preproc_lib = "CNNPreprocessor_memorieswithproductkeys_connector_predictor_executor"
        ...
        for epoch in range(begin_epoch, begin_epoch + num_epoch):
            ...
            for batch_i, batch in enumerate(train_iter):
                ...
                with autograd.record():
                    ...
                    data_2_ = gluon.utils.split_and_load(batch.data[2], ctx_list=mx_context, even_split=False)
                    ...
                    net_ret = [self._networks[0](data_0_[i], data_1_[i], data_2_[i]) for i in range(num_pus)]
            ...
            if eval_train:
                ...
                for batch_i, batch in enumerate(train_iter):
                    ...
                    data_2_ = batch.data[2].as_in_context(mx_context[0])
                    ...
                    net_ret = self._networks[0](data_0_, data_1_, data_2_)
