...
#ifndef MEMORIESWITHPRODUCTKEYS_STREAM_TEST
#define MEMORIESWITHPRODUCTKEYS_STREAM_TEST
...
namespace memorieswithproductkeys_stream_test{
...
void test_case_memorieswithproductkeys_StreamTest(){
    mat tmpA;
    mat tmpB;
    memorieswithproductkeys_stream component;
    std::ofstream myfile;
    myfile.open ("memorieswithproductkeys.StreamTest");
    myfile.precision(64);
    component.init();
            component.tens = 1.0;
            component.ones = 1.0;
    ...
    rangeValueCheck(component.number, 111.0 , 111.0);
            ...
            myfile << "\n";
    myfile.close();
    std::cout << "memorieswithproductkeys.StreamTest: success\n";
}
...
int runTest(){
    ...
    __StacktraceFile << "~Entering memorieswithproductkeys.StreamTest" << std::endl;
    __StacktraceFile.close();
    test_case_memorieswithproductkeys_StreamTest();
