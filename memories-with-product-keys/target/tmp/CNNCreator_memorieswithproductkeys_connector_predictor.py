...
from CNNNet_memorieswithproductkeys_connector_predictor import Net_0

class CNNCreator_memorieswithproductkeys_connector_predictor:
    _model_dir_ = "model/memorieswithproductkeys.Network/"
    ...
    def construct(self, context, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((1, 5,), ctx=context[0]), mx.nd.zeros((1, 5,), ctx=context[0]), mx.nd.zeros((1, 1,), ctx=context[0]))
    ...
    def getInputs(self):
        inputs = {}
        input_dimensions = (5,)
        input_domains = (int,0.0,float('inf'),)
