#ifndef CNNPREDICTOR_MEMORIESWITHPRODUCTKEYS_NETWORK
#define CNNPREDICTOR_MEMORIESWITHPRODUCTKEYS_NETWORK
...
#include <CNNLAOptimizer_memorieswithproductkeys_network.h>

using namespace mxnet::cpp;    
    
class CNNPredictor_memorieswithproductkeys_network_0{
public:
    ...
    explicit CNNPredictor_memorieswithproductkeys_network_0(){
        init(file_prefix, network_input_keys, network_input_shapes);
    }

    ~CNNPredictor_memorieswithproductkeys_network_0(){
    ...
    void init(const std::string &file_prefix,
        ...
        CNNLAOptimizer_memorieswithproductkeys_network optimizer_creator = CNNLAOptimizer_memorieswithproductkeys_network();
...
#endif // CNNPREDICTOR_MEMORIESWITHPRODUCTKEYS_NETWORK
