...
from CNNNet_cNNCalculator_connector_predictor import Net_0

class CNNCreator_cNNCalculator_connector_predictor:
    _model_dir_ = "model/cNNCalculator.Generator/"
    ...
    def construct(self, context, data_mean=None, data_std=None):
        ...
        self.networks[0](mx.nd.zeros((1, 100,1,1,), ctx=context))
