...
module.exports = Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('@elysium/access-controller/lib/browser/access-controller-frontend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@elysium/query-controller/lib/browser/query-controller-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@elysium/query-controller/lib/browser/mode/mode-frontend-module')).then(load) })
