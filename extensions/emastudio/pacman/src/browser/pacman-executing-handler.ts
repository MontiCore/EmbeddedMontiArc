...
@injectable()
export class PacManExecutingHandler implements ExecutingHandler {
    ...
    public async isEnabled(): Promise<boolean> {
        ...
        return workspace && workspace.uri.endsWith("PacMan");
    }
    ...
    protected async openMiniBrowser(): Promise<void> {
        const endpoint = new Endpoint({ path: `${PACMAN_STATIC_PATH}/simulation.html` });
