...
cd ${CLASSIFIER_CPP}
g++ -std=c++11 ImageClassifier.cpp -o ImageClassifier -I. -I${MXNET_HOME}/include -L${MXNET_HOME}/lib -lmxnet -llapack -lblas -larmadillo  `pkg-config --cflags --libs opencv`
