...
mkdir "%VERIFICATION_HOME%\WitnessSVG"
...
(
echo ^<!DOCTYPE html^>
echo   ^<html^>^<body^>^<header^>Witness %temp%Witness!number! doesn't verify model %temp3%^</header^>
...
(
echo ^<!DOCTYPE html^>
echo   ^<html^>^<body^>^<header^>Witness %temp%Witness!number! verifies model %temp3%^</header^>
echo       ^<iframe src="%adress3%%temp%Witness!number!.html" height=400 width=800^>
echo   ^</iframe^>^<p^>^</p^>
echo   ^</body^>^</html^>
) >> %VERIFICATION_HOME%\WitnessSVG\%temp3%Witness!number!.html
