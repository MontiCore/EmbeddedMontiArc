...
BATCHES.AUTOPILOT.VISUALIZATIONRES1    			= Path.resolve(PATHS.SCRIPTS, "autopilot", "visualizeRes1.bat");
BATCHES.AUTOPILOT.VISUALIZATIONRES2    			= Path.resolve(PATHS.SCRIPTS, "autopilot", "visualizeRes2.bat");
