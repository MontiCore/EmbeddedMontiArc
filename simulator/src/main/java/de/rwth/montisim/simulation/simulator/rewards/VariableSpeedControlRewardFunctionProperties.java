...
class VariableSpeedControlRewardFunctionProperties extends RewardFunctionProperties {
  ...
  public float CONTROL_EFFORT_REWARD_SCALING = 1;
  public float CONTROL_EFFORT_DERIVATIVE_REWARD_SCALING = 0.05f;
  ...
  public RewardFunction build(Vehicle[] vehicles, Duration tickDuration) {
    return new VariableSpeedControlRewardFunction(vehicles, tickDuration, VELOCITY_DIFFERENCE_REWARD_SCALING, VELOCITY_SUB_MAXIMUM_REWARD, STANDING_REWARD, CONTROL_EFFORT_REWARD_SCALING, CONTROL_EFFORT_DERIVATIVE_REWARD_SCALING, velocity_max, velocity_desired, standing_threshold, standing_punishment_from_step, standing_punishment_to_min_path_distance);
  }
