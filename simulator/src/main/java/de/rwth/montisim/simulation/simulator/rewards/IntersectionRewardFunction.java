...
public class IntersectionRewardFunction extends RewardFunction {
    ...
    public IntersectionRewardFunction(Vehicle[] vehicles, Duration tickDuration, float vehicle_collision_factor,
                                      float static_collision_factor, float trajectory_reward_factor,
                                      float angular_jerk_reward_factor, float angular_acc_reward_factor,
                                      float linear_jerk_reward_factor, float linear_acc_reward_factor, float trajectory_following_reward,
                                      float total_path_progress_reward_scaling, float path_progress_derivative_reward_scaling, float distance_max,
                                      float velocity_difference_scaling, float velocity_sub_maximum_reward, float standing_punishment,
                                      float velocity_max, float velocity_desired, float standing_threshold, int standing_punishment_from_step,
                                      float standing_punishment_to_min_path_distance) {
        ...
        TrajectoryRewardFunction trajReward = new TrajectoryRewardFunction(vehicles, tickDuration, TRAJECTORY_FOLLOWING_REWARD,
                TOTAL_PATH_PROGRESS_REWARD_SCALING, PATH_PROGRESS_DERIVATIVE_REWARD_SCALING, DISTANCE_MAX);
        SpeedControlRewardFunction speedReward = new SpeedControlRewardFunction(vehicles, tickDuration, VELOCITY_DIFFERENCE_SCALING,
                VELOCITY_SUB_MAXIMUM_REWARD, STANDING_PUNISHMENT, LINEAR_ACC_REWARD_FACTOR, LINEAR_JERK_REWARD_FACTOR,
                ANGULAR_ACC_REWARD_FACTOR, ANGULAR_JERK_REWARD_FACTOR, this.velocity_max, this.velocity_desired, this.standing_threshold, this.standing_punishment_from_step,
                this.standing_punishment_to_min_path_distance);
