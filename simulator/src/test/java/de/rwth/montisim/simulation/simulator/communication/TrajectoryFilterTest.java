...
public class TrajectoryFilterTest {
  ...
  public void testKeepOrder() {
    ...
    float[] result = new TrajectoryFilter(1.5f, 4.5f, 25).preprocessState(vehicleState, otherStates, 25);

    float[] correct_solution = new float[25*3];
    System.arraycopy(vehicleState, 0, correct_solution, 0, 25);
    System.arraycopy(otherState1, 0, correct_solution, 1*25, 25);
  ...
  public void testOneIntersection() {
    ...
    float[] result = new TrajectoryFilter(1.5f, 4.5f, 1000).preprocessState(vehicleState, otherStates, 25);

    float[] correct_solution = new float[25*3];
    System.arraycopy(vehicleState, 0, correct_solution, 0, 25);
    System.arraycopy(otherState2, 0, correct_solution, 1*25, 25);
