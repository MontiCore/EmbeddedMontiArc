 ...
 */
public class TransCostConnSymbolCreator implements TagSymbolCreator {
    ...
    for (ASTTag element : unit.getTagBody().getTagList()) {
          ...
          .forEachOrdered(v ->
              element.getScopeList().stream()
                ...
                .map(Optional::get)
                .forEachOrdered(s -> tagging.addTag(s, new TransCostConnSymbol(
  ...
  protected boolean checkScope(ASTScope scope) {
    ...
    Log.error(String.format("0xT0005 Invalid scope kind: '%s'. TransCostConn expects as scope kind 'ConnectorScope'.",
