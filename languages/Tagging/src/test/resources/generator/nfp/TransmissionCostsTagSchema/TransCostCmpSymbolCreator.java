 ...
 */
public class TransCostCmpSymbolCreator implements TagSymbolCreator {
    ...
    for (ASTTag element : unit.getTagBody().getTagList()) {
          ...
          .forEachOrdered(v ->
              element.getScopeList().stream()
                ...
                .map(Optional::get)
                .forEachOrdered(s -> tagging.addTag(s, new TransCostCmpSymbol(
  ...
  protected boolean checkScope(ASTScope scope) {
    ...
    Log.error(String.format("0xT0005 Invalid scope kind: '%s'. TransCostCmp expects as scope kind 'NameScope'.",
