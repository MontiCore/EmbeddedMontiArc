...
public class ASTOpenRange extends ASTOpenRangeTOP {

    public ASTOpenRange() {
    }

    public ASTOpenRange(ASTNumberWithInf min, Optional<ASTNumberWithInf> step, ASTNumberWithInf max, String left, String right) {
