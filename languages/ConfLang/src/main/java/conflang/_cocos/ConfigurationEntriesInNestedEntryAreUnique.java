...
public class ConfigurationEntriesInNestedEntryAreUnique implements ConfLangASTNestedConfigurationEntryCoCo {

    @Override
    public void check(ASTNestedConfigurationEntry configurationEntry) {
        List<ASTConfigurationEntry> configurationEntries = configurationEntry.getConfigurationEntryList();
