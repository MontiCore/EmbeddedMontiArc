...
/**
 * Class that represents a Street Lantern in the simulation
 */
public class StreetLantern implements SimulationObject {
    ...
    public StreetLantern() {
        objectData = new StaticObject("StreetLantern");
        // TODO
        // width = 1.0;
        // length = 1.0;
        // height = 0.5;
