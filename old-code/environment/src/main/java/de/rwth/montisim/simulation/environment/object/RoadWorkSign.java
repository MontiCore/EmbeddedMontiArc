 ...
 */
public class RoadWorkSign implements SimulationObject {

    StaticObject objectData;

    /**
     * Constructor for a road work sign that is standing at its position Initial
     * position at origin
     */
    public RoadWorkSign() {
        objectData = new StaticObject("RoadSign");
        // TODO
        // width = 1.0;
        // length = 1.0;
        // height = 0.5;
