...
public class WeatherParser extends MCConcreteParser {
   ...
   * @throws IOException 
   */
  public Optional<numberunit._ast.ASTNumber> parseNumber(String filename) throws IOException {   
    WeatherAntlrParser parser = create(filename);    
	numberunit._ast.ASTNumber ast;
    ...
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<numberunit._ast.ASTNumber> empty();
    }
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTNumber> parseNumber(Reader reader) throws IOException {
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTNumber> parseString_Number(String str) throws IOException {
   ...
   * @throws IOException 
   */
  public Optional<numberunit._ast.ASTFloatPointUnitNumber> parseFloatPointUnitNumber(String filename) throws IOException {   
    WeatherAntlrParser parser = create(filename);    
	numberunit._ast.ASTFloatPointUnitNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
    ...
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<numberunit._ast.ASTFloatPointUnitNumber> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTFloatPointUnitNumber> parseFloatPointUnitNumber(Reader reader) throws IOException {
 	WeatherAntlrParser parser = create(reader);
	numberunit._ast.ASTFloatPointUnitNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
      ast = parser.floatPointUnitNumber().ret;
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTFloatPointUnitNumber> parseString_FloatPointUnitNumber(String str) throws IOException {
   ...
   * @throws IOException 
   */
  public Optional<numberunit._ast.ASTHexUnitNumber> parseHexUnitNumber(String filename) throws IOException {   
    WeatherAntlrParser parser = create(filename);    
	numberunit._ast.ASTHexUnitNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
    ...
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<numberunit._ast.ASTHexUnitNumber> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTHexUnitNumber> parseHexUnitNumber(Reader reader) throws IOException {
 	WeatherAntlrParser parser = create(reader);
	numberunit._ast.ASTHexUnitNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
      ast = parser.hexUnitNumber().ret;
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTHexUnitNumber> parseString_HexUnitNumber(String str) throws IOException {
   ...
   * @throws IOException 
   */
  public Optional<numberunit._ast.ASTUnitNumber> parseUnitNumber(String filename) throws IOException {   
    WeatherAntlrParser parser = create(filename);    
	numberunit._ast.ASTUnitNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
    ...
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<numberunit._ast.ASTUnitNumber> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTUnitNumber> parseUnitNumber(Reader reader) throws IOException {
 	WeatherAntlrParser parser = create(reader);
	numberunit._ast.ASTUnitNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
      ast = parser.unitNumber().ret;
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTUnitNumber> parseString_UnitNumber(String str) throws IOException {
   ...
   * @throws IOException 
   */
  public Optional<numberunit._ast.ASTComplexNumber> parseComplexNumber(String filename) throws IOException {   
    WeatherAntlrParser parser = create(filename);    
	numberunit._ast.ASTComplexNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
    ...
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<numberunit._ast.ASTComplexNumber> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTComplexNumber> parseComplexNumber(Reader reader) throws IOException {
 	WeatherAntlrParser parser = create(reader);
	numberunit._ast.ASTComplexNumber ast;
    if (getParserTarget().equals(MCConcreteParser.ParserExecution.NORMAL)) {
      ast = parser.complexNumber().ret;
   ...
   * @throws IOException 
   * */
  public  Optional<numberunit._ast.ASTComplexNumber> parseString_ComplexNumber(String str) throws IOException {
