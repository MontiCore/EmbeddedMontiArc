...
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  /* generated by template ast.Attribute*/
   ...
   protected  String weatherPressure;
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_010 Parameter 'visitor' must not be null.");
   ...
   public  void accept(numberunit._visitor.NumberUnitVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_437 Parameter 'visitor' must not be null.");
   ...
   public  boolean deepEquals(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_813 Parameter 'o' must not be null.");
   ...
   public  boolean deepEqualsWithComments(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_042 Parameter 'o' must not be null.");
   ...
   public  boolean deepEqualsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_340 Parameter 'o' must not be null.");
   ...
   public  boolean equalAttributes(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_635 Parameter 'o' must not be null.");
    ...
    if ( (this.weatherPressure == null && comp.weatherPressure != null) 
      || (this.weatherPressure != null && !this.weatherPressure.equals(comp.weatherPressure)) ) {
      return false;
    }
    return true;     
   ...
   public  boolean equalsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_289 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_111 Parameter 'child' must not be null.");
   ...
   public  ASTPressure deepClone(ASTPressure result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_792 Parameter 'result' must not be null.");

     /* generated by template ast.additionalmethods.DeepCloneWithParameters*/
  
    super.deepClone(result);
    
    result.weatherPressure = this.weatherPressure;
   ...
   public  void setWeatherPressure(String weatherPressure)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(weatherPressure, "0xA7006_414 Parameter 'weatherPressure' must not be null.");

     /* generated by template ast_emf.additionalmethods.Set*/

    String oldWeatherPressure = this.weatherPressure;
   ...
   public  void eSet(int featureID,Object newValue)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTPressure_WeatherPressure:
        setWeatherPressure((String)newValue);
        return;
    }
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_498 Parameter 'baseClass' must not be null.");
 ...
 /**
  ...
  public static class Builder  {
    ...
    public Builder weatherPressure(String weatherPressure) {
      this.weatherPressure = weatherPressure;
      return this;
    }
