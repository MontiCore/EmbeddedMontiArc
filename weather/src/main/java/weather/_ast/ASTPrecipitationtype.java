...
import org.eclipse.emf.ecore.util.EObjectContainmentEList;
 ...
 public  class ASTPrecipitationtype extends /* generated by template ast.AstSuperTypes*/
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  /* generated by template ast.Attribute*/
   ...
   protected  ASTPrecipitationtype (/* generated by template ast.ParametersDeclaration*/
  ...
  { // empty body 
   ...
   protected  ASTPrecipitationtype (/* generated by template ast.ConstructorParametersDeclaration*/
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_690 Parameter 'visitor' must not be null.");
   ...
   public  void accept(numberunit._visitor.NumberUnitVisitor visitor)   { 
    ...
    if (visitor instanceof weather._visitor.WeatherVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_648AST node type ASTPrecipitationtype of the sub language Weather expected a visitor of type weather._visitor.WeatherVisitor, but got numberunit._visitor.NumberUnitVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_771 Parameter 'o' must not be null.");

     /* generated by template ast.additionalmethods.DeepEqualsWithOrder*/

      ASTPrecipitationtype comp;
    if ((o instanceof ASTPrecipitationtype)) {
      comp = (ASTPrecipitationtype) o;
    } else {
      return false;
    }
   ...
   public  boolean deepEquals(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_901 Parameter 'o' must not be null.");
   ...
   public  boolean deepEqualsWithComments(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_352 Parameter 'o' must not be null.");
   ...
   public  boolean equalAttributes(Object o)   { 
    ...
    if (!(this.precipitationType == comp.precipitationType)) {
      return false;
    }
    return true;     
   ...
   public  boolean equalsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_385 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_412 Parameter 'child' must not be null.");
   ...
   public  ASTPrecipitationtype deepClone()   { 
   ...
   public  ASTPrecipitationtype deepClone(ASTPrecipitationtype result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_068 Parameter 'result' must not be null.");

     /* generated by template ast.additionalmethods.DeepCloneWithParameters*/
  
    super.deepClone(result);
    
    result.precipitationType = this.precipitationType;
   ...
   protected  ASTPrecipitationtype _construct()   { 
   ...
   public  void setPrecipitationType(int precipitationType)   { 
    ...
    int oldPrecipitationType = this.precipitationType;
    this.precipitationType = precipitationType;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, WeatherPackage.ASTPrecipitationtype_PrecipitationType, oldPrecipitationType, precipitationType));
    }  
   ...
   public  Object eGet(int featureID,boolean resolve,boolean coreType)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTPrecipitationtype_PrecipitationType:
   ...
   public  void eSet(int featureID,Object newValue)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTPrecipitationtype_PrecipitationType:
        setPrecipitationType((int)newValue);
        return;
    }
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_719 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_390 Parameter 'baseClass' must not be null.");
   ...
   protected  EClass eStaticClass()   { 
     ...
     return WeatherPackage.Literals.ASTPrecipitationtype;
  } 
 ...
 /**
   * Builder for {@link ASTPrecipitationtype}.
   */
  public static class Builder  {
    /* generated by template ast.BuilderAttribute*/
     protected  int precipitationType;

    public ASTPrecipitationtype build() {
      return new ASTPrecipitationtype (/* generated by template ast.BuilderConstructorParametersDeclaration*/
    ...
    public Builder precipitationType(int precipitationType) {
      this.precipitationType = precipitationType;
      return this;
    }
