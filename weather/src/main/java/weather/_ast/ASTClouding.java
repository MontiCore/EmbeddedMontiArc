...
import org.eclipse.emf.ecore.util.EObjectContainmentEList;
 ...
 public  class ASTClouding extends /* generated by template ast.AstSuperTypes*/
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  /* generated by template ast.Attribute*/
  
   protected  int cloudingType;

    /* generated by template ast.Constructor*/
  
   protected  ASTClouding (/* generated by template ast.ParametersDeclaration*/
  ...
  { // empty body 
   ...
   protected  ASTClouding (/* generated by template ast.ConstructorParametersDeclaration*/
     int cloudingType 
 
    )  
  /* generated by template ast.ConstructorAttributesSetter*/
  {
    setCloudingType(cloudingType);
  }
   ...
   public  boolean equalAttributes(Object o)   { 
	...
	// comparing cloudingType 
    if (!(this.cloudingType == comp.cloudingType)) {
      return false;
    }
    return true;     
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_263 Parameter 'child' must not be null.");
   ...
   public  ASTClouding deepClone(ASTClouding result)   { 
     /* generated by template ast.ErrorIfNull*/
    ...
    result.cloudingType = this.cloudingType;
   ...
   protected  ASTClouding _construct()   { 
   ...
   public  int getCloudingType()   { 
     
     /* generated by template ast.additionalmethods.Get*/

    return  this.cloudingType;

  } 

    /* generated by template ast.ClassMethod*/
  
   public  void setCloudingType(int cloudingType)   { 
     
     /* generated by template ast_emf.additionalmethods.Set*/

    int oldCloudingType = this.cloudingType;
    this.cloudingType = cloudingType;
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, WeatherPackage.ASTClouding_CloudingType, oldCloudingType, cloudingType));
    }  
   ...
   public  Object eGet(int featureID,boolean resolve,boolean coreType)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTClouding_CloudingType:
         return getCloudingType();
    }
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_937 Parameter 'baseClass' must not be null.");
   ...
   protected  EClass eStaticClass()   { 
     ...
     return WeatherPackage.Literals.ASTClouding;
  } 
 ...
 /**
   * Builder for {@link ASTClouding}.
   */
  public static class Builder  {
    /* generated by template ast.BuilderAttribute*/
     protected  int cloudingType;

    public ASTClouding build() {
      return new ASTClouding (/* generated by template ast.BuilderConstructorParametersDeclaration*/
    ...
    public Builder cloudingType(int cloudingType) {
      this.cloudingType = cloudingType;
      return this;
    }
