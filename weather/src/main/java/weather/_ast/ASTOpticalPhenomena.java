...
import org.eclipse.emf.ecore.util.EObjectContainmentEList;
 ...
 public  class ASTOpticalPhenomena extends /* generated by template ast.AstSuperTypes*/
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  /* generated by template ast.Attribute*/
   ...
   protected  ASTOpticalPhenomena (/* generated by template ast.ParametersDeclaration*/
  ...
  { // empty body 
   ...
   protected  ASTOpticalPhenomena (/* generated by template ast.ConstructorParametersDeclaration*/
     int phenomenaType 
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(numberunit._visitor.NumberUnitVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_988 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof weather._visitor.WeatherVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_188AST node type ASTOpticalPhenomena of the sub language Weather expected a visitor of type weather._visitor.WeatherVisitor, but got numberunit._visitor.NumberUnitVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_872 Parameter 'o' must not be null.");

     /* generated by template ast.additionalmethods.DeepEqualsWithOrder*/

      ASTOpticalPhenomena comp;
    if ((o instanceof ASTOpticalPhenomena)) {
      comp = (ASTOpticalPhenomena) o;
    } else {
      return false;
    }
   ...
   public  boolean deepEqualsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_355 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_634 Parameter 'child' must not be null.");
   ...
   public  ASTOpticalPhenomena deepClone()   { 
   ...
   public  ASTOpticalPhenomena deepClone(ASTOpticalPhenomena result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_715 Parameter 'result' must not be null.");
   ...
   protected  ASTOpticalPhenomena _construct()   { 
   ...
   public  void setPhenomenaType(int phenomenaType)   { 
    ...
    if (eNotificationRequired()) {
      eNotify(new ENotificationImpl(this, Notification.SET, WeatherPackage.ASTOpticalPhenomena_PhenomenaType, oldPhenomenaType, phenomenaType));
    }  
   ...
   public  Object eGet(int featureID,boolean resolve,boolean coreType)   { 
    ...
    switch (featureID) {
      case WeatherPackage.ASTOpticalPhenomena_PhenomenaType:
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_158 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_356 Parameter 'baseClass' must not be null.");
   ...
   protected  EClass eStaticClass()   { 
     ...
     return WeatherPackage.Literals.ASTOpticalPhenomena;
  } 
 ...
 /**
   * Builder for {@link ASTOpticalPhenomena}.
   */
  public static class Builder  {
    /* generated by template ast.BuilderAttribute*/
     protected  int phenomenaType;

    public ASTOpticalPhenomena build() {
      return new ASTOpticalPhenomena (/* generated by template ast.BuilderConstructorParametersDeclaration*/
