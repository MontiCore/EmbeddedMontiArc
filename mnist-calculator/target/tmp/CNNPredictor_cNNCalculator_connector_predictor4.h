...
public:
    const std::string json_file = "model/cNNCalculator.Network/model_0_newest-symbol.json";
    const std::string param_file = "model/cNNCalculator.Network/model_0_newest-0000.params";
