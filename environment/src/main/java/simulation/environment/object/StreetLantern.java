...
public class StreetLantern implements SimulationLoopExecutable, PhysicalObject {
    ...
    /**
     * Constructor for a street lantern that is standing at its position
    ...
    public void setGeometryPositionOffset(RealVector geometryPositionOffset){
        try {
            ...
            Log.severe("StreetLantern: setGeometryPositionOffset - Could not set geometryPositionOffset. Rotation matrix inversion failed");
            e.printStackTrace();
        }
    }
