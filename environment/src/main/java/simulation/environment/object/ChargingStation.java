...
public class ChargingStation implements SimulationLoopExecutable, PhysicalObject {
	...
	private ArrayList<Car> carObjects = new ArrayList<>();
	...
	public boolean startCharging(Car car) {
		...
		if (carStaningAtTheCS(car) && (!isOccupied())) {
			...
			cp.startProcess();
			chargingProcessesMap.put(car, cp);
			return true;
	 ...
	 * 
	 * @param position
	 *            New position vector of the center of mass
	 */
	@Override
	 ...
	 * 
	 * @param rotation
	 *            New rotation matrix around the center of mass
	 */
	@Override
	 ...
	 * 
	 * @param velocity
	 *            New velocity vector of the center of mass
	 */
	@Override
	 ...
	 *            New angular velocity around of the center of mass
	 */
	 ...
	 * 
	 * @param force
	 *            Force vector that acts on the center of mass
	 */
	@Override
	 ...
	 * 
	 * @param torque
	 *            Torque vector that acts around the center of mass
	 */
	 ...
	 * 
	 * @param mass
	 *            New mass of the physical object
	 */
	@Override
	 ...
	 *            New position vector of the center of geometry
	 */
	@Override
	 ...
	 * 
	 * @param geometryPositionOffset
	 *            New offset vector of the center of mass position to the center of
	 *            geometry position
	 */
	@Override
	 ...
	 * 
	 * @param error
	 *            New Error flag of the physical object
	 */
	@Override
	 ...
	 * 
	 * @param collision
	 *            New collision flag of the physical object
	 */
	@Override
	public void setCollision(boolean collision) {
		Log.warning(
				"Charging Station: setCollision - collision: " + collision + ", Charging Station at start: " + this);
	 ...
	 * 
	 * @param deltaTms
	 *            Duration of the current simulation step in milliseconds
	 */
	@Override
	 ...
	 * 
	 * @param posX
	 *            X component of the position of the physical object
	 * @param posY
	 *            Y component of the position of the physical object
	 * @param rotZ
	 *            Z component of the rotation of the physical object
	 */
	@Override
	public void putOnSurface(double posX, double posY, double rotZ) {
		double groundZ = WorldModel.getInstance().getGround(posX, posY, this.getGeometryPosition().getEntry(2))
				.doubleValue();
	 ...
	 * 
	 * @param timeDiffMs
	 *            Difference in time measured in milliseconds
	 */
	@Override
