...
public class ChargingStation implements SimulationLoopExecutable, PhysicalObject {
    ...
    public boolean startCharging(ChargingProcess.ChargeableVehicle vehicle) throws Exception {
        ...
        if (carStaningAtTheCS(vehicle) && (!isOccupied())) {
    ...
    public boolean carStaningAtTheCS(ChargingProcess.ChargeableVehicle vehicle) {
...
//	}
     ...
     *
     * @param geometryPositionOffset New offset vector of the center of mass position to the center of
     *                               geometry position
     */
    @Override
