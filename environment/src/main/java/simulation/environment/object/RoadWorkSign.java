...
/**
 * Class that represents a road work sign in the simulation
 */
public class RoadWorkSign implements SimulationLoopExecutable, PhysicalObject {
    ...
    /**
     * Constructor for a road work sign that is standing at its position
    ...
    public RoadWorkSign() {
        ...
        physicalObjectType = PhysicalObjectType.PHYSICAL_OBJECT_TYPE_ROAD_WORK_SIGN;
        error = false;
        collision = false;
    }
    ...
    public void setError(boolean error){
        Log.warning("RoadWorkSign: setError - error: " + error + ", RoadWorkSign at start: " + this);
        this.error = error;
        Log.warning("RoadWorkSign: setError - error: " + error + ", RoadWorkSign at end: " + this);
    }
    ...
    public void executeLoopIteration(long timeDiffMs) {
        // do nothing: road work signs do not move
    }
}
