...
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  ...
  { // empty body 
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_062 Parameter 'visitor' must not be null.");
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_746 Parameter 'visitor' must not be null.");
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_650 Parameter 'o' must not be null.");

     /* generated by template ast.additionalmethods.DeepEqualsWithOrder*/

    return o instanceof ASTPrecipitationtype;
   ...
   public  boolean deepEquals(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_677 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_633 Parameter 'child' must not be null.");
   ...
   public  ASTPrecipitationtype deepClone(ASTPrecipitationtype result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_960 Parameter 'result' must not be null.");
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_162 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_748 Parameter 'baseClass' must not be null.");
 ...
 /**
  ...
  public static class Builder  {
    public ASTPrecipitationtype build() {
      return new ASTPrecipitationtype (/* generated by template ast.ParametersDeclaration*/
    // Parameters declaration
