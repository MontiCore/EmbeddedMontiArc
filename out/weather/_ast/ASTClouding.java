...
de.monticore.emf._ast.ASTECNode implements  ASTWeatherNode
 {
  ...
  { // empty body 
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_771 Parameter 'visitor' must not be null.");
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
    ...
    return o instanceof ASTClouding;
   ...
   public  boolean equalsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_412 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_068 Parameter 'child' must not be null.");
   ...
   public  ASTClouding deepClone(ASTClouding result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_390 Parameter 'result' must not be null.");
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_898 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_334 Parameter 'baseClass' must not be null.");
 ...
 /**
  ...
  public static class Builder  {
    public ASTClouding build() {
      return new ASTClouding (/* generated by template ast.ParametersDeclaration*/
    // Parameters declaration
