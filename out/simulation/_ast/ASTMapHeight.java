...
de.monticore.emf._ast.ASTECNode implements  ASTSimulationNode
 {
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(simulation._visitor.SimulationVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_295 Parameter 'visitor' must not be null.");
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_187 Parameter 'visitor' must not be null.");
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_970 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof simulation._visitor.SimulationVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_000AST node type ASTMapHeight of the sub language Simulation expected a visitor of type simulation._visitor.SimulationVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean equalsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_159 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_377 Parameter 'child' must not be null.");
   ...
   public  ASTMapHeight deepClone(ASTMapHeight result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_040 Parameter 'result' must not be null.");
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_522 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_092 Parameter 'baseClass' must not be null.");
