...
import org.eclipse.emf.ecore.util.EObjectContainmentEList;
 ...
 public  class ASTSimulationType extends /* generated by template ast.AstSuperTypes*/
de.monticore.emf._ast.ASTECNode implements  ASTSimulationNode
 {
    /* generated by template ast.Constructor*/
  
   protected  ASTSimulationType (/* generated by template ast.ParametersDeclaration*/
  ...
  { // empty body 
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_692 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof simulation._visitor.SimulationVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_084AST node type ASTSimulationType of the sub language Simulation expected a visitor of type simulation._visitor.SimulationVisitor, but got weather._visitor.WeatherVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_808 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof simulation._visitor.SimulationVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_193AST node type ASTSimulationType of the sub language Simulation expected a visitor of type simulation._visitor.SimulationVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
    ...
    return o instanceof ASTSimulationType;
   ...
   public  boolean deepEqualsWithComments(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_755 Parameter 'o' must not be null.");
   ...
   public  boolean equalAttributes(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_315 Parameter 'o' must not be null.");
   ...
   public  boolean equalsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_212 Parameter 'o' must not be null.");

     /* generated by template ast.additionalmethods.EqualsWithComments*/

      ASTSimulationType comp;
    if ((o instanceof ASTSimulationType)) {
      comp = (ASTSimulationType) o;
    } else {
      return false;
    }
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_705 Parameter 'child' must not be null.");
   ...
   public  ASTSimulationType deepClone()   { 
   ...
   public  ASTSimulationType deepClone(ASTSimulationType result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_763 Parameter 'result' must not be null.");
   ...
   protected  ASTSimulationType _construct()   { 
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_614 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_202 Parameter 'baseClass' must not be null.");
   ...
   protected  EClass eStaticClass()   { 
     ...
     return SimulationPackage.Literals.ASTSimulationType;
  } 
 ...
 /**
   * Builder for {@link ASTSimulationType}.
   */
  public static class Builder  {
    public ASTSimulationType build() {
      return new ASTSimulationType (/* generated by template ast.ParametersDeclaration*/
    // Parameters declaration
