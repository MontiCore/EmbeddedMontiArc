...
de.monticore.emf._ast.ASTECNode implements  ASTSimulationNode
 {
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(simulation._visitor.SimulationVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_818 Parameter 'visitor' must not be null.");
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_622 Parameter 'visitor' must not be null.");
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_282 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof simulation._visitor.SimulationVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_892AST node type ASTWeatherObj of the sub language Simulation expected a visitor of type simulation._visitor.SimulationVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEqualsWithComments(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_096 Parameter 'o' must not be null.");
   ...
   public  boolean equalAttributes(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_074 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_395 Parameter 'child' must not be null.");
   ...
   public  ASTWeatherObj deepClone(ASTWeatherObj result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_863 Parameter 'result' must not be null.");
   ...
   public  void setArtificialPhenomenas(java.util.List<weather._ast.ASTArtificialPhenomena> artificialPhenomenas)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(artificialPhenomenas, "0xA7006_618 Parameter 'artificialPhenomenas' must not be null.");
   ...
   public  void setClouding(weather._ast.ASTClouding clouding)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(clouding, "0xA7006_262 Parameter 'clouding' must not be null.");
   ...
   public  void setOpticalPhenomenas(java.util.List<weather._ast.ASTOpticalPhenomena> opticalPhenomenas)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(opticalPhenomenas, "0xA7006_835 Parameter 'opticalPhenomenas' must not be null.");
   ...
   public  void setPrecipitationtype(weather._ast.ASTPrecipitationtype precipitationtype)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(precipitationtype, "0xA7006_789 Parameter 'precipitationtype' must not be null.");
   ...
   public  void setSight(weather._ast.ASTSight sight)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(sight, "0xA7006_529 Parameter 'sight' must not be null.");
   ...
   public  void setTemperature(weather._ast.ASTTemperature temperature)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(temperature, "0xA7006_283 Parameter 'temperature' must not be null.");
   ...
   public  void setWeatherPhenomenas(java.util.List<weather._ast.ASTWeatherPhenomena> weatherPhenomenas)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(weatherPhenomenas, "0xA7006_270 Parameter 'weatherPhenomenas' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_444 Parameter 'baseClass' must not be null.");
