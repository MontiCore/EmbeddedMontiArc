...
de.monticore.emf._ast.ASTECNode implements  ASTSimulationNode
 {
  ...
  /* generated by template ast.ConstructorAttributesSetter*/
  {
   ...
   public  void accept(simulation._visitor.SimulationVisitor visitor)   { 
    ...
    Log.errorIfNull(visitor, "0xA7006_638 Parameter 'visitor' must not be null.");
   ...
   public  void accept(weather._visitor.WeatherVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_566 Parameter 'visitor' must not be null.");
   ...
   public  void accept(si._visitor.SIVisitor visitor)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(visitor, "0xA7006_236 Parameter 'visitor' must not be null.");
    ...
    if (visitor instanceof simulation._visitor.SimulationVisitor) {
      ...
      de.se_rwth.commons.logging.Log.error("0xA7000_665AST node type ASTMapName of the sub language Simulation expected a visitor of type simulation._visitor.SimulationVisitor, but got si._visitor.SIVisitor. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
    }
   ...
   public  boolean deepEquals(Object o,boolean forceSameOrder)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_805 Parameter 'o' must not be null.");
   ...
   public  boolean deepEquals(Object o)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(o, "0xA7006_455 Parameter 'o' must not be null.");
   ...
   public  void remove_Child(de.monticore.ast.ASTNode child)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(child, "0xA7006_437 Parameter 'child' must not be null.");
   ...
   public  ASTMapName deepClone(ASTMapName result)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(result, "0xA7006_322 Parameter 'result' must not be null.");
   ...
   public  void setMapName(String mapName)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(mapName, "0xA7006_897 Parameter 'mapName' must not be null.");
   ...
   public  int eBaseStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_974 Parameter 'baseClass' must not be null.");
   ...
   public  int eDerivedStructuralFeatureID(int featureID,Class<?> baseClass)   { 
     /* generated by template ast.ErrorIfNull*/
    Log.errorIfNull(baseClass, "0xA7006_025 Parameter 'baseClass' must not be null.");
