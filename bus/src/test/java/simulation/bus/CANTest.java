...
//        for (Bus bus: buses) {
//            int test = bus.getConnectedComponents().size();
//            if(test == 5){
//                can = (CAN) bus;
//            }
//        }
...
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.HEADER_SIZE + CAN.MAX_PAYLOAD_SIZE/2)));
...
//
//        //finish off packet
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.MAX_PAYLOAD_SIZE/2 + CAN.TRAILER_SIZE)));
//        assertEquals(CAN.MAX_PAYLOAD_SIZE * 2, low.getTransmittedBytes());
//
//
//        //stop transmission in header
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.HEADER_SIZE -2)));
//        assertEquals(CAN.MAX_PAYLOAD_SIZE * 2, low.getTransmittedBytes());
...
//
//        //finish off packet
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(2 + CAN.MAX_PAYLOAD_SIZE + CAN.TRAILER_SIZE)));
//        assertEquals(CAN.MAX_PAYLOAD_SIZE * 2, low.getTransmittedBytes());
//        assertEquals(CAN.MAX_PAYLOAD_SIZE, medium.getTransmittedBytes());
//
//
//        //stop transmission in trailer
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.MAX_MESSAGE_SIZE-3)));
//        assertEquals(CAN.MAX_PAYLOAD_SIZE * 2, low.getTransmittedBytes());
//        assertEquals(CAN.MAX_PAYLOAD_SIZE, medium.getTransmittedBytes());
//        assertEquals(CAN.MAX_PAYLOAD_SIZE, high.getTransmittedBytes());
//
//        //finish off packet
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(3)));
//        assertEquals(CAN.MAX_PAYLOAD_SIZE * 2, low.getTransmittedBytes());
//        assertEquals(CAN.MAX_PAYLOAD_SIZE, medium.getTransmittedBytes());
...
//
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.MAX_MESSAGE_SIZE)));
//        assertEquals(CAN.MAX_MESSAGE_SIZE, msg.getRemainingBytes());
...
//        assertEquals(expected, can.getNextFinishTime());
//
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(50)));
//        expected = can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.MAX_MESSAGE_SIZE-60));
//        assertEquals(expected, can.getNextFinishTime());
//
//        can.simulateUntil(can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.MAX_MESSAGE_SIZE)));
//        expected = can.getCurrentTime().plusNanos(can.calculateTransmissionTime(CAN.MAX_MESSAGE_SIZE * 2 + CAN.MAX_PAYLOAD_SIZE/2 + CAN.HEADER_SIZE + CAN.TRAILER_SIZE - 60));
//        assertEquals(expected, can.getNextFinishTime());
//
//    }
//
