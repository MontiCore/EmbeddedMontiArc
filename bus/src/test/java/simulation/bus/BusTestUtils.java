...
public class BusTestUtils {
    ...
    public static BusMessage createNregisterMessage(Bus bus, Object message, int senderPos, int messageLength,
                                              int priority) {
    ...
    public static List<BusMessage> createNregisterMessages(Bus bus) {
