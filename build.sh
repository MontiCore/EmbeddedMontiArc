...
rm -rf target
java -jar embedded-montiarc-emadl-generator-0.6.0-SNAPSHOT-jar-with-dependencies.jar -m src/main/emadl/models -r mnistvae.Connector -o target -b GLUON -p /usr/bin/python3
